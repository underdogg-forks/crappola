...
$LANG = [
    ...
    'invoice_subject'                     => ':company 帳戶下的第 :number 筆新發票',
    ...
    'quote_subject'                            => ':company 的第 :number 份新報價單',
    ...
    'gateway_help_27'                          => ':link 以註冊 2Checkout.com。 欲確保付款能被追查，請在 2Checkout 入口網頁的 company > Site Management 設定 :complete_link 作為重新轉向的的網址。',
    ...
    'reminder_subject'                     => '提醒函: :company 的發票 :invoice',
    'reset'                                => '重設',
...
<ul><li>以彈性的商營運方式進行貸款與發票結帳。</li></ul>',
    ...
    'purge_details'           => '已成功地清除您的公司 (:company) 資料。',
    'deleted_company'         => '刪除公司資料成功',
    'deleted_account'         => '取消帳戶成功',
    'deleted_company_details' => '已成功地刪除您的公司 (:company) 資料。',
    'deleted_account_details' => '已成功地刪除您的帳戶 (:company) 資料。',
    ...
    'proposal_subject'                           => ':company 的新提案 :number',
