...
<li> "Задржано плаќање за :QUARTER+1" >> "Задржано плаќање за К2" </li>
    ...
    'invoice_subject'                     => 'Нова фактура :number од :company',
 ...
 --пратете ни е-пошта на contact@invoiceninja.com',
    ...
    'quote_subject'                            => 'Нова понуда :number од :company',
    ...
    'gateway_help_27'                          => ':link за регистрирање на 2Checkout.com. За да се осигурате дека плаќањата се следат поставете го :complete_link како URL за пренасочување под company > Site Management во порталот на 2Checkout.com. ',
 ...
 <p> Ако ви треба помош околу нешто објавете прашање на нашиот :forum_link со дизајнот кој го користите. </p>',
    ...
    'reminder_subject'                     => 'Потсетник: Фактурата :invoice од :company',
    'reset'                                => 'Ресетирај',
...
Откако ќе ги добиете износите, вратете се на оваа страница за начин на плаќање и кликнете "Заврши Верификација" до сметката.',
    ...
    'ach_authorization'                           => 'Одобрувам :companyPlan да ја користи мојата банкарска сметка за идни плаќања и, ако е потребно, електронски да ја кредитира мојата сметка за да ги поправи погрешните дебити. Разбирам дека можам да ја откажам оваа дозвола во било кое време со отстранување на начинот на плаќање или преку контактирање на :email.',
 ...
 <ul> <li> Флексибилни бизнис линии на кредит и факторинг на фактури </li> </ul> ',
    ...
    'purge_details'           => 'Податоците на вашата компанија (:company) се успешно прочистени.',
    'deleted_company'         => 'Успешно избришана компанија',
    'deleted_account'         => 'Успешно откажана сметка',
    'deleted_company_details' => 'Вашата компанија (:company) е успешно избришана.',
    'deleted_account_details' => 'Вашата сметка (:company) е успешно избришана.',
    ...
    'proposal_subject'                           => 'Нов предлог :number од :company',
