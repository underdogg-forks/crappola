...
',
    ...
    'invoice_subject'                     => 'Нова фактура :number  от :company',
...
във фактурата, за да платите за една година Pro план<p/>
    ...
    'quote_subject'                            => 'Нова Оферта :number от :company',
    ...
    'gateway_help_27'                          => ':link за регистрация в 2Checkout.com. За да осигурите проследяване на плащанията въведете :complete_link като "redirect URL" в менюто company > Site Management в портала на 2Checkout.',
    ...
    'reminder_subject'                     => 'Напомняне: Фактура :invoice от :company',
    'reset'                                => 'Нулиране',
...
<ul><li>Гъвкави бизнес линии за факторинг по кредити и фактури.</li></ul>',
    ...
    'purge_details'           => 'Данните във Вашата фирма (:company) са изчистени успешно.',
    'deleted_company'         => 'Успешно изтриване на фирма',
    'deleted_account'         => 'Успешно прекратен акаунт',
    'deleted_company_details' => 'Вашата фирма (:company) е изтрита успешно.',
    'deleted_account_details' => 'Вашият профил (:company) е изтрит успешно.',
    ...
    'iban'                                       => 'IBAN',
    'sepa_authorization'                         => 'Като предоставяте своя IBAN и потвърждавате това плащане, упълномощавате :companyPlan и Stripe, нашия доставчик на платежни услуги, да изпратят указания на банката Ви за дебитиране на сметката Ви и банката Ви за дебитиране на сметката Ви в съответствие с тези инструкции. Имате право на възстановяване на сумата от банката съгласно условията на споразумението с Вашата банка. Възстановяването трябва да бъде заявено в рамките на 8 седмици, считано от датата на дебитиране на сметката Ви.',
    ...
    'proposal_subject'                           => 'Ново предложение :number от :company',
