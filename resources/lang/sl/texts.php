...
$LANG = [
    ...
    'invoice_subject'                     => 'Nov račun :number od :company',
...
Ne morete najti računa? Potrebujete dodatno pomoč? Z veseljem bomo pomagali. Pošljite nam e-pošto na contact@invoiceninja.com',
    ...
    'gateway_help_27'                          => ':link za prijavo na 2Checkout.com. Za zagotovitev da bodo plačiia izsledena nastavite :complete_link za preusmeritveni naslov (URL) pod company > Site Management v 2Checkout portalu.',
...
<p>Če potrebujete pomoč nam pošljite vprašanje na :forum_link z zasnovo, ki jo uporabljate.</p>',
    ...
    'reminder_subject'                     => 'Opomin: račun :invoice od :company',
    'reset'                                => 'Ponastavi',
...
Ko imate zneske, se vrnite na to stran plačilnega sredstva in kliknite na "Complete Verification".',
    ...
    'ach_authorization'                           => 'Pooblaščam :companyPlan za uporabo mojega bančnega računa za prihodnja plačila. Razumem, da lahko prekličem pooblastilo kadarkoli z odstranitvijo plačilnega sredstva ali z zahtevo na naslov :email.',
...
<ul><li>Prožna poslovna področja kreditiranja in odkup računov.</li></ul>',
    ...
    'purge_details'           => 'Podatki o vašem podjetju (:companyPlan) so bili uspešno počiščeni.',
    'deleted_company'         => 'Podjetje uspešno odstranjeno',
    'deleted_account'         => 'Račun uspešno preklican',
    'deleted_company_details' => 'Vaš račun za podjetje (:company) je bil uspešno odstranjen.',
    'deleted_account_details' => 'Vaš račun (:company) je bil uspešno odstranjen.',
    ...
    'proposal_subject'                           => 'Nova ponudba :number od :company',
