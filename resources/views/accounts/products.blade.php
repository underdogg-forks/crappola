...
@section('content')
    ...
    @include('companies.nav', ['selected' => ACCOUNT_PRODUCTS])

    {!! Former::open()->addClass('warn-on-exit') !!}

    {{ Former::populateField('show_product_notes', intval($company->show_product_notes)) }}
    ...
    {{ Former::populateField('convert_products', intval($company->convert_products)) }}
