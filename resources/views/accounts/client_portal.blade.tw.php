            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="link">
                        <div class="panel-body lg:w-4/5 pr-4 pl-4 col-lg-offset-1">
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    <div role="tabpanel" class="tab-pane active" id="password">
                        <div class="panel-body">
                          <div class="flex flex-wrap lg:w-4/5 pr-4 pl-4 col-lg-offset-1">
                        ...
                        @if ($account->enable_buy_now_buttons)
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane active" id="buy_now_link">
                                    <textarea id="linkTextarea" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" rows="4" readonly></textarea>
                                </div>
                                <div role="tabpanel" class="tab-pane" id="form">
                                    <textarea id="formTextarea" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" rows="4" readonly></textarea>
                                </div>
                            </div>
...
<div class="modal opacity-0" id="iframeHelpModal" tabindex="-1" role="dialog" aria-labelledby="iframeHelpModalLabel" aria-hidden="true">
