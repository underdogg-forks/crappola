...
@section('content')
            ...
            <div class="tab-content">
                ...
                @if ($account->hasFeature(FEATURE_DOCUMENTS))
                    <div role="tabpanel" class="tab-pane" id="documents">
                        <div class="panel-body">
                            <div class="mb-4">
                                <div class="lg:w-full pr-4 pl-4 sm:w-full pr-4 pl-4">
    ...
    <div class="modal opacity-0" id="patternHelpModal" tabindex="-1" role="dialog" aria-labelledby="patternHelpModalLabel" aria-hidden="true">
