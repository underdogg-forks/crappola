<div class="panel panel-default">
  <div class="panel-heading">
    ...
    @if (! empty($warning))
        <div class="relative px-3 py-3 mb-4 border rounded text-yellow-darker border-yellow-dark bg-yellow-lighter">{{ trans('texts.import_warning_' . $warning) }}</div>
    @endif

    <table class="w-full max-w-full mb-4 bg-transparent invoice-table">
        <thead>
            <tr>
