...
@section('content')
    ...
    {!! Former::populateField('gateway_fee_enabled', $company->gateway_fee_enabled) !!}
    {!! Former::populateField('send_item_details', $company->send_item_details) !!}
                                ...
                                <div role="tabpanel" class="tab-pane" id="fees">
                                    ...
                                    <div id="feesEnabled" class="panel-body">
                                        ...
                                        <div class="help-block">
                                            ...
                                            @if ($company->gateway_fee_enabled && !$company->invoice_item_taxes && $company->invoice_taxes && count($taxRates))
    ...
    <script>
        ...
        @foreach ($company->account_gateway_settings as $setting)
        ...
        function showLimitsModal(gateway_type, gateway_type_id) {
            ...
            if (gateway_type_id == {{ GATEWAY_TYPE_CUSTOM1 }} ||
                ...
                gateway_type_id == {{ GATEWAY_TYPE_CUSTOM3 }} ||
                    {{ $company->gateway_fee_enabled ? '0' : '1' }}) {
                $('#feesEnabled').hide();
                $('#feesDisabled').show();
            } else {
                $('#feesDisabled').hide();
