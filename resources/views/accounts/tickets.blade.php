...
@section('content')
    ...
    {{ Former::populate($company_ticket_settings) }}
    {{ Former::populateField('local_part', $company_ticket_settings->support_email_local_part) }}

    @include('companies.nav', ['selected' => ACCOUNT_TICKETS])
                    ...
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            <li role="presentation" class="active"><a href="#defaults" aria-controls="notes" role="tab"
                                                                      data-toggle="tab">{{ trans('texts.defaults') }}</a>
                            </li>
                            <li role="presentation"><a href="#domain" aria-controls="terms" role="tab"
                                                       data-toggle="tab">{{ trans('texts.domain') }}</a></li>
                            <li role="presentation"><a href="#attachments" aria-controls="footer" role="tab"
                                                       data-toggle="tab">{{ trans('texts.attachments') }}</a></li>
                            <li role="presentation"><a href="#notifications" aria-controls="footer" role="tab"
                                                       data-toggle="tab">{{ trans('texts.notifications') }}</a></li>
                            <li role="presentation"><a href="#templates" aria-controls="footer" role="tab"
                                                       data-toggle="tab">{{ trans('texts.templates') }}</a></li>
                        </ul>
                                ...
                                <div class="panel-body form-padding-right">
                                    ...
                                    <div id="max_file_size">
                                        {!! Former::select('max_file_size')
                                            ...
                                            ->fromQuery($company_ticket_settings->max_file_sizes())
