...
@section('content')
    ...
    {!! Former::populateField('signature_on_pdf', intval($company->signature_on_pdf)) !!}

    @include('companies.nav', ['selected' => ACCOUNT_CLIENT_PORTAL, 'advanced' => true])
                ...
                <div class="panel-body">
                    ...
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist" style="border: none">
                            ...
                            @if (Utils::isSelfHost())
                                <li role="presentation">
                                    <a href="#custom_js" aria-controls="custom_js" role="tab"
                                       data-toggle="tab">{{ trans('texts.custom_js') }}</a>
                                </li>
                            @endif
                        </ul>
                    </div>
                    ...
                    <div class="tab-content">
                            ...
                            <div class="panel-body col-lg-10 col-lg-offset-1">
                                ...
                                @if (Utils::isNinja())
                                    ...
                                    {!! Former::inline_radios('custom_invoice_link')
                                            ...
                                            ])->check($company->iframe_url ? ($company->is_custom_domain ? 'domain' : 'iframe') : 'subdomain') !!}
                        ...
                        <div role="tabpanel" class="tab-pane" id="messages">
                            <div class="panel-body">
                                ...
                                @foreach (App\Models\company::$customMessageTypes as $type)
                            ...
                            <div class="panel-body">
                                <div class="row col-lg-10 col-lg-offset-1">
                                    ...
                                    {!! Former::plaintext('client_login')
                                        ->value(link_to($company->present()->clientLoginUrl, null, ['target' => '_blank']))
                                        ->help(Utils::isNinja() && ! $company->subdomain && ! $company->iframe_url ? 'improve_client_portal_link' : '') !!}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row col-lg-10 col-lg-offset-1">
                        ...
                        @if (count($gateway_types) && count($products))
                            ...
                            @if ($company->enable_buy_now_buttons)
                                ...
                                @if (count($company->present()->customTextFields))
                                    {!! Former::inline_checkboxes('custom_fields')
                                            ->onchange('updateBuyNowButtons()')
                                            ->checkboxes($company->present()->customTextFields) !!}
                                @endif
    ...
    <script type="text/javascript">
        ...
        function updateBuyNowButtons() {
            ...
            if (productId) {
                ...
                var domain = '{{ $company->present()->clientPortalLink(true) }}/buy_now';
                @else
                ...
                @foreach ($company->present()->customTextFields as $field => $val)
