        ...
        <div class="flex flex-wrap">
            ...
            <div class="md:w-1/2 pr-4 pl-4">
                ...
                {!! Former::textarea('email_template_' . $field)
                        ...
                        ->style('display:none') !!}
                <div id="{{ $field }}Editor" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" style="min-height:160px">
                </div>
            </div>
            <div class="md:w-1/2 pr-4 pl-4">
                <p>&nbsp;<p/>
