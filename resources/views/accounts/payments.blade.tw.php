...
@section('content')
  ...
  {!! Datatable::table()
    ...
    <div class="modal opacity-0" id="paymentLimitsModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" style="min-width:150px">
            <div class="modal-content">
				...
				<div class="container mx-auto" style="width: 100%; padding-bottom: 2px !important">
	            <div class="panel panel-default">
	            <div class="panel-body">
					<div role="tabpanel">
			                    ...
			                    <div class="flex flex-wrap">
			                        <div class="md:w-1/2 pr-4 pl-4">
			                            <div id="payment-limit-min-container">
			                                ...
			                                <div class="relative flex items-stretch w-full" style="padding-bottom:8px">
			                                    <span class="py-1 px-2 mb-1 text-base font-normal leading-normal text-grey-darkest text-center bg-grey-light border border-4 border-grey-lighter rounded">{{ $currency->symbol }}</span>
			                                    <input type="number" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" min="0" id="payment-limit-min"
			                                           name="limit_min">
			                                </div>
			                        ...
			                        <div class="md:w-1/2 pr-4 pl-4">
			                            <div id="payment-limit-max-container">
			                                ...
			                                <div class="relative flex items-stretch w-full" style="padding-bottom:8px">
			                                    <span class="py-1 px-2 mb-1 text-base font-normal leading-normal text-grey-darkest text-center bg-grey-light border border-4 border-grey-lighter rounded">{{ $currency->symbol }}</span>
			                                    <input type="number" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" min="0" id="payment-limit-max"
			                                           name="limit_max">
			                                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-blue-lightest bg-blue hover:bg-blue-light" id="modalSave">{{ trans('texts.save') }}</button>
                </div>
            </div>
        </div>
    </div>
