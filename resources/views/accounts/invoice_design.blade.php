...
@section('content')
    @parent
    @include('companies.nav', ['selected' => ACCOUNT_INVOICE_DESIGN, 'advanced' => true])
    ...
    <script>
        ...
        function getPDFString(cb) {
            ...
            var fields = {!! json_encode(App\Models\company::$customLabels) !!};
        ...
        function updateFieldLabels() {
            @foreach (App\Models\company::$customLabels as $field)
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            {!! Former::populateField('quote_design_id', $company->quote_design_id) !!}
            ...
            {!! Former::populateField('background_image_id', $company->background_image ? $company->background_image->public_id : null) !!}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        {!! Former::select('label_field')
                                                ...
                                                ->options(array_combine(App\Models\company::$customLabels, Utils::trans(App\Models\company::$customLabels))) !!}
                                    </div>
                                    <div class="col-md-6">
                                        @foreach (App\Models\company::$customLabels as $field)
                        ...
                        <div role="tabpanel" class="tab-pane" id="invoice_fields">
                            <div class="panel-body">
                                <div class="row" id="invoiceFields">
                                    ...
                                    @include('companies.partials.invoice_fields_selector', ['section' => 'account_fields1', 'fields' => INVOICE_FIELDS_ACCOUNT])
                                    @include('companies.partials.invoice_fields_selector', ['section' => 'account_fields2', 'fields' => INVOICE_FIELDS_ACCOUNT])
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="product_fields">
                            <div class="panel-body">
                                <div class="row" id="productFields">
                                    @include('companies.partials.invoice_fields_selector', ['section' => 'product_fields', 'fields' => INVOICE_FIELDS_PRODUCT, 'colWidth' => 6])
                                    @include('companies.partials.invoice_fields_selector', ['section' => 'task_fields', 'fields' => INVOICE_FIELDS_TASK, 'colWidth' => 6])
                                </div>
                                <div class="row" style="padding-top:30px">
                                    <div class="pull-left help-block">
                            ...
                            <div class="panel-body">
                                ...
                                @if (auth()->user()->isEnterprise())
                                    {!! Former::select('background_image_id')
                                            ...
                                            ->help($company->isModuleEnabled(ENTITY_PROPOSAL)
            ...
            <center class="buttons">
                {!! $company->getCustomDesign(CUSTOM_DESIGN1) ?
                        DropdownButton::primary(trans('texts.customize'))
                            ->withContents($company->present()->customDesigns)
                            ->large()  :
