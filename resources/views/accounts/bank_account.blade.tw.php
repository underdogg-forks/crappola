...
@section('content')
    ...
    <div class="panel-body">
        ...
        <div class="lg:w-full pr-4 pl-4 sm:w-full pr-4 pl-4" data-bind="visible: page() == 'setup'" style="display:none">
            <table class="w-full max-w-full mb-4 bg-transparent accounts-table" style="width:100%">
                <thead>
                    <tr>
                ...
                <tbody data-bind="foreach: bank_accounts">
                    <tr>
                        <td>
                            <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" data-bind="value: account_name, valueUpdate: 'afterkeydown', attr: {name: 'bank_accounts[' + $index() + '][account_name]'}"/>
        ...
        <div class="lg:w-full pr-4 pl-4 sm:w-full pr-4 pl-4" data-bind="visible: page() == 'import'" style="display:none">
            <div class="flex flex-wrap panel" style="padding-top:10px;padding-bottom:12px;">
                <div class="md:w-2/3 pr-4 pl-4" style="padding-top:10px;">
                    <span data-bind="text: statusLabel"></span>
                </div>
                <div class="md:w-1/3 pr-4 pl-4">
                    <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" data-bind="value: $root.filter, valueUpdate: 'afterkeydown'"
                ...
                <table class="w-full max-w-full mb-4 bg-transparent accounts-table" style="width:100%;">
                    ...
                    <tbody data-bind="foreach: filteredTransactions">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded"
        ...
        <div class="lg:w-full pr-4 pl-4 sm:w-full pr-4 pl-4" data-bind="visible: page() == 'done'" style="display:none">
            <div class="relative px-3 py-3 mb-4 border rounded text-teal-darker border-teal-dark bg-teal-lighter" role="alert">
              <span class="glyphicon glyphicon-ok-sign" aria-hidden="true"></span>
              <span data-bind="text: importResults()"></span>
            </div>
        </div>

        <div class="lg:w-full pr-4 pl-4 sm:w-full pr-4 pl-4" data-bind="visible: isLoading" style="display:none">
            <p>&nbsp;</p>
            <div class="progress">
        ...
        <div class="lg:w-full pr-4 pl-4 sm:w-full pr-4 pl-4" data-bind="visible: errorStr" style="display:none">
