	...
	<div class="md:w-full pr-4 pl-4">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				@else
					<div class="mb-4">
						<label class="sm:w-1/3 pr-4 pl-4 control-label">{{ trans('texts.plan') }}</label>
					...
					@if ($planDetails && $planDetails['active'])
						<div class="mb-4">
							<label class="sm:w-1/3 pr-4 pl-4 control-label">
								{{ trans('texts.renews') }}
							</label>
							<div class="sm:w-2/3 pr-4 pl-4">
								<p class="form-control-static">
		...
		@if (Utils::isNinjaProd())
			<div class="modal opacity-0" id="changePlanModel" tabindex="-1" role="dialog" aria-labelledby="changePlanModelLabel" aria-hidden="true">
				<div class="modal-dialog" style="min-width:150px">
					<div class="modal-content">
						...
						<div class="modal-footer">
                            ...
                            @endif
							<button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default" data-dismiss="modal">{{ trans('texts.go_back') }}</button>
							@if ($planDetails && $planDetails['active'])
								<button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-blue-lightest bg-blue hover:bg-blue-light" id="changePlanButton" onclick="confirmChangePlan()">{{ trans('texts.plan_change') }}</button>
							@else
								<button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-green-lightest bg-green hover:bg-green-light" id="changePlanButton" onclick="confirmChangePlan()">{{ trans('texts.plan_upgrade') }}</button>
							@endif
						</div>
					</div>
				</div>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="mb-4">
					<label for="modules" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4"></label>
				...
				<div class="panel-body">
					<div class="mb-4">
						...
						<div class="lg:w-2/3 pr-4 pl-4 sm:w-2/3 pr-4 pl-4">
							...
							<a class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-blue-lightest bg-blue hover:bg-blue-light py-3 px-4 text-xl leading-tight"
		...
		@if (! Auth::user()->account->isNinjaOrLicenseAccount())
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<br/>
					<div class="modal opacity-0" id="confirmPurgeModal" tabindex="-1" role="dialog" aria-labelledby="confirmPurgeModalLabel" aria-hidden="true">
						<div class="modal-dialog" style="min-width:150px">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="absolute pin-t pin-b pin-r px-4 py-3" data-dismiss="modal" aria-hidden="true">&times;</button>
								...
								<div class="modal-footer" style="margin-top: 2px">
									<button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default" data-dismiss="modal">{{ trans('texts.go_back') }}</button>
									<button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-red-lightest bg-red hover:bg-red-light" id="purgeButton" onclick="confirmPurge()">{{ trans('texts.purge_data') }}</button>
								</div>
							</div>
						</div>
					</div>
					...
					@if (! $account->hasMultipleAccounts() || $account->getPrimaryAccount()->id != $account->id)
						...
						<div class="modal opacity-0" id="confirmCancelModal" tabindex="-1" role="dialog" aria-labelledby="confirmCancelModalLabel" aria-hidden="true">
							<div class="modal-dialog" style="min-width:150px">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="absolute pin-t pin-b pin-r px-4 py-3" data-dismiss="modal" aria-hidden="true">&times;</button>
