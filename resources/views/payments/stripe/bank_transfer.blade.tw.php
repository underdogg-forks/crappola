...
@section('payment_details')
    ...
    @if ($accountGateway->getPlaidEnabled())
        <div id="plaid_container">
            <a class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default py-3 px-4 text-xl leading-tight" id="plaid_link_button">
    ...
    <div id="manual_container">
        ...
        <div class="mb-4" style="margin-top:-15px">
            <div class="md:w-2/3 pr-4 pl-4 col-md-offset-4">
