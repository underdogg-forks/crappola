...
@section('head')
    ...
    <script type="text/javascript">
        Stripe.setPublishableKey('{{ $companyGateway->getPublishableKey() }}');
        $(function () {
...
@section('payment_details')
    ...
    <div id="manual_container">
        ...
        {!! Former::radios('account_holder_type')->radios(array(
                ...
                trans('texts.company_account') => array('value' => 'companyPlan'),
    ...
    {!! Former::checkbox('authorize_ach')
            ->text(trans('texts.ach_authorization', ['companyPlan'=>$company->getDisplayName(), 'email' => $company->work_email]))
            ->label(' ')
            ->value(1) !!}
