...
@section('payment_details')
    ...
    <div style="padding-bottom: 22px;">
        ...
        <div class="flex flex-wrap" style="display:{{ isset($paymentTitle) || empty($contact->email) ? 'block' : 'none' }}">
            ...
            @else
                <div class="col-lg-{{ ($accountGateway->gateway_id == GATEWAY_BRAINTREE) ? 12 : 8 }}">
                    ...
                    <div class="flex flex-wrap">
                        <div class="md:w-full pr-4 pl-4">
                            @if ($accountGateway->gateway_id == GATEWAY_BRAINTREE)
                                <div id="card_number" class="braintree-hosted block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded"></div>
                            @else
                    ...
                    <div class="flex flex-wrap">
                        <div class="md:w-2/5 pr-4 pl-4">
                            @if ($accountGateway->gateway_id == GATEWAY_BRAINTREE)
                                <div id="expiration_month" class="braintree-hosted block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded"></div>
                            @else
                        ...
                        <div class="md:w-1/3 pr-4 pl-4">
                            @if ($accountGateway->gateway_id == GATEWAY_BRAINTREE)
                                <div id="expiration_year" class="braintree-hosted block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded"></div>
                            @else
                        ...
                        <div class="md:w-1/4 pr-4 pl-4">
                            @if ($accountGateway->gateway_id == GATEWAY_BRAINTREE)
                                <div id="cvv" class="braintree-hosted block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded"></div>
                            @else
                ...
                <div class="lg:w-1/3 pr-4 pl-4" style="padding-top: 12px; padding-left: 0px;">
    ...
    <div class="flex flex-wrap" style="padding-top:18px">
        <div class="md:w-full pr-4 pl-4">
    ...
    <div class="md:w-full pr-4 pl-4">
        <div id="js-error-message" style="display:none" class="relative px-3 py-3 mb-4 border rounded text-red-darker border-red-dark bg-red-lighter"></div>
    </div>
