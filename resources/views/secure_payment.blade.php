...
@section('content')
    ...
    <section class="secure">
        <div class="container">
                ...
                <div class="col-md-5">
                    <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><span class="glyphicon glyphicon-credit-card" style="margin-right: 10px;"></span><a
                                            href="#">Where Do I find CVV?</a></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <button type="submit" id="feedbackSubmit" class="btn btn-primary btn-lg green">PAY NOW - $2.00
                    </button>
                </div>
                </form>
            </div>
