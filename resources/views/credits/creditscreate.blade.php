...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Enter Credit | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/credits/create"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Credits &gt; Enter Credit"
            href="https://invoice-ninja.readthedocs.io/en/latest/credits.html#enter-credit" target="_blank">
...
<script type="text/javascript">
	...
	<form accept-charset="utf-8" class="form-horizontal col-lg-10 col-lg-offset-1 warn-on-exit" method="POST" action="/credits">
	...
	<div class="row">
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="panel-body">
							...
							<div class="form-group client-select required"><label for="client_id" class="control-label col-lg-4 col-sm-4">Client</label><div class="col-lg-8 col-sm-8"><select required class="form-control" id="client_id" name="client_id"><option value=""></option></select></div></div>
			
			<div class="form-group required"><label for="amount" class="control-label col-lg-4 col-sm-4">Amount</label><div class="col-lg-8 col-sm-8"><input required class="form-control" id="amount" type="text" name="amount"></div></div>

			
			<div class="form-group credit_date"><label for="credit_date" class="control-label col-lg-4 col-sm-4">Credit Date</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" data-date-format="M d, yyyy" id="credit_date" type="text" name="credit_date"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span></div></div></div>

			<div class="form-group"><label for="public_notes" class="control-label col-lg-4 col-sm-4">Public Notes</label><div class="col-lg-8 col-sm-8"><textarea class="form-control" rows="4" id="public_notes" name="public_notes"></textarea></div></div>
			<div class="form-group"><label for="private_notes" class="control-label col-lg-4 col-sm-4">Private Notes</label><div class="col-lg-8 col-sm-8"><textarea class="form-control" rows="4" id="private_notes" name="private_notes"></textarea></div></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/credits.html#enter-credit" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/credits/create' != settingsURL) {
