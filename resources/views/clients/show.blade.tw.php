...
@section('content')
	...
	<div class="flex flex-wrap">
		...
		<div class="md:w-1/4 pr-4 pl-4">
            ...
            <div class="text-grey" style="padding-top:8px">
                ...
                @if (Auth::user()->confirmed && $client->account->enable_client_portal)
                    ...
                    @if (config('services.postmark'))
                        <div style="padding-top:10px">
                            <a href="#" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline py-1 px-2 text-sm leading-tight text-blue-lightest bg-blue hover:bg-blue-light" onclick="showEmailHistory('{{ $contact->email }}')">
		...
		<div class="md:w-1/4 pr-4 pl-4">
			...
			<table class="w-full max-w-full mb-4 bg-transparent" style="width:100%">
				<tr>
	...
	<ul class="flex flex-wrap list-reset pl-0 mb-0 border border-t-0 border-r-0 border-l-0 border-b-1 border-grey-light ">
    ...
    <div class="modal opacity-0" id="emailHistoryModal" tabindex="-1" role="dialog" aria-labelledby="emailHistoryModalLabel" aria-hidden="true">
