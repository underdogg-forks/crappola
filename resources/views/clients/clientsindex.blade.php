...
<head>
    ...
    <title>Clients | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/clients"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <div id="left-sidebar-wrapper" class="hide-phone">
        <ul class="sidebar-nav sidebar-nav-dark">
            ...
            <li class="nav-settings ">
                ...
                <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Clients &gt; List Clients"
                   href="https://invoice-ninja.readthedocs.io/en/latest/clients.html#list-clients" target="_blank">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <form accept-charset="utf-8" class="form-horizontal listForm_client" method="POST" action="/clients/bulk">

                <div style="display:none">
                    <div class="form-group"><label for="action_client"
                                                   class="control-label col-lg-4 col-sm-4">Action</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="action_client" type="text"
                                                              name="action"></div>
                    </div>
                    <div class="form-group"><label for="public_id_client" class="control-label col-lg-4 col-sm-4">public
                            id</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="public_id_client" type="text"
                                                              name="public_id"></div>
                    </div>
                ...
                <div class="pull-left">
                    ...
                    <div class='btn-group'>
                        ...
                        <ul class='dropdown-menu' role='menu' aria-labelledby='dLabel'>
                            <li><a href='javascript:submitForm_client("archive")'>Archive Client</a></li>
                            <li><a href='javascript:submitForm_client("delete")'>Delete Client</a></li>
                        </ul>
                    </div>
		...
		<select class="form-control" style="width: 220px" id="statuses_client" multiple="true">
                ...
                <div id="top_right_buttons" class="pull-right">
                    ...
                    <a class='btn btn-primary' href='http://invninjv1.local/clients/create'>New Client <span
                                class='glyphicon glyphicon-plus-sign'></span></a>

                </div>


                <table class="table table-striped data-table FPoZQJaG">
                    <colgroup>
                        <col class="con0"/>
                        <col class="con1"/>
                        <col class="con2"/>
                ...
                <script type="text/javascript">
                    ...
                    function load_FPoZQJaG() {
                        window['dataTable_clients'] = jQuery('.FPoZQJaG').dataTable({
                            "stateSave": true,
                            "stateDuration": 0,
                            ...
                            "sPaginationType": "bootstrap",
                            "bProcessing": false,
                            "sAjaxSource": "http:\/\/invninjv1.local\/api\/clients",
                            "bServerSide": true,
                            "aaSorting": [[4, "desc"]],
            ...
            <style type="text/css">
                ...
                .listForm_client table.dataTable td:nth-child(7) {
                    text-align: right;
                }
            ...
            <script type="text/javascript">
                ...
                $(function () {
                    ...
                    window.onDatatableReady_clients = function () {
                    ...
                    function changeSumLabel() {
                        ...
                        sumColumnNodes = dTable.column(6).data().toArray();
                        var sum = 0;
                        ...
                        if (sum) {
                            $('#sum_column_client').show().text("Total: " + sum)
                        } else {
                    ...
                    $('#statuses_client').select2({
                        ...
                        .on('change', function () {
                            ...
                            var url = 'http://invninjv1.local/set_entity_filter/client' + '/' + filter;
                            $.get(url, function (data) {
                                refreshDatatable_clients();
                            })
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href="https://invoice-ninja.readthedocs.io/en/latest/clients.html#list-clients" target="_blank">User
                        Guide</a>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('http://invninjv1.local/clients' != settingsURL) {
