            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-default" style="min-height: 380px">
                    ...
                    <div class="panel-body">
                        ...
                        @if ($company->usesClientInvoiceCounter())
                        ...
                        <div class="tab-content" style="padding-top:24px;">
                            <div role="tabpanel" class="tab-pane active" id="settings">
                                {!! Former::select('currency_id')->addOption('','')
                                    ->placeholder($company->currency ? $company->currency->getTranslatedName() : '')
                                ...
                                @if ($company->isModuleEnabled(ENTITY_TASK))
                                    {!! Former::text('task_rate')
                                            ->placeholder($company->present()->taskRate)
                                            ->help('task_rate_help') !!}
                                ...
                                <div role="tabpanel" class="tab-pane" id="messages">
                                    @foreach (App\Models\company::$customMessageTypes as $type)
                                        {!! Former::textarea('custom_messages[' . $type . ']')
                                                ->placeholder($company->customMessage($type))
                                                ->label($type) !!}
                                    @endforeach
                                </div>
                            @endif
