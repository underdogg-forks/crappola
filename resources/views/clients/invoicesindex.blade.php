...
<head>
    ...
    <title>Invoices | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/invoices"/>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="height:60px;">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-1">
        ...
        <form accept-charset="utf-8" class="form-horizontal navbar-form navbar-right" id="search-form" role="search"
              method="POST" action="/handle_command">
...
<div id="wrapper" class=' toggled-right'>
        ...
        <ul class="sidebar-nav sidebar-nav-dark">
            ...
            <li class="nav-settings ">
                ...
                <a type="button" class="btn btn-default btn-sm pull-right"
                   title="User Guide: Invoices &gt; List Invoices"
                   href="https://invoice-ninja.readthedocs.io/en/latest/invoices.html#list-invoices" target="_blank">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <form accept-charset="utf-8" class="form-horizontal listForm_invoice" method="POST" action="/invoices/bulk">

                <div style="display:none">
                    <div class="form-group"><label for="action_invoice"
                                                   class="control-label col-lg-4 col-sm-4">Action</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="action_invoice" type="text"
                                                              name="action"></div>
                    </div>
                    <div class="form-group"><label for="public_id_invoice" class="control-label col-lg-4 col-sm-4">public
                            id</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="public_id_invoice" type="text"
                                                              name="public_id"></div>
                    </div>
                    <div class="form-group"><label for="datatable"
                                                   class="control-label col-lg-4 col-sm-4">datatable</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="datatable" type="text"
                                                              name="datatable" value="true"></div>
                    </div>
                </div>
                ...
                <div class="pull-left">
                    ...
                    <div class='btn-group'>
                        <button class='btn btn-default archive' type='button'>Archive</button>
                        <button class='btn btn-default dropdown-toggle archive' data-toggle='dropdown' type='button'>
                            <span class='caret'></span></button>
                        <ul class='dropdown-menu' role='menu' aria-labelledby='dLabel'>
                            <li><a href='javascript:submitForm_invoice("download")'>Download Invoice</a></li>
                            <li><a href='javascript:submitForm_invoice("emailInvoice")'>Email Invoice</a></li>
                            <li class='divider'></li>
                            <li><a href='javascript:submitForm_invoice("markSent")'>Mark Sent</a></li>
                            <li><a href='javascript:submitForm_invoice("markPaid")'>Mark Paid</a></li>
                            <li class='divider'></li>
                            <li><a href='javascript:submitForm_invoice("archive")'>Archive Invoice</a></li>
                            <li><a href='javascript:submitForm_invoice("delete")'>Delete Invoice</a></li>
                        </ul>
                    </div>

                    &nbsp;
                    <span id="statusWrapper_invoice" style="display:none">
		<select class="form-control" style="width: 220px" id="statuses_invoice" multiple="true">
				...
				<optgroup label="Status">
                    ...
                    &nbsp;
                    <span class="well well-sm" id="sum_column_invoice"
                          style="display:none;padding-left:12px;padding-right:12px;"></span>
                </div>

                <div id="top_right_buttons" class="pull-right">
                    <input id="tableFilter_invoice" type="text"
                    ...
                    <div class='btn-group'>
                        <button class='btn btn-default recurringDropdown' type='button'>Recurring Invoices</button>
                        <button class='btn btn-default dropdown-toggle recurringDropdown' data-toggle='dropdown'
                                type='button'><span class='caret'></span></button>
                        <ul class='dropdown-menu' role='menu' aria-labelledby='dLabel'>
                            <li><a href='http://invninjv1.local/recurring_invoices/create'>New Recurring Invoice</a>
                            </li>
                        </ul>
                    </div>
                    <script type="text/javascript">
                        $(function () {
                            $('.recurringDropdown:not(.dropdown-toggle)').click(function (event) {
                                openUrlOnClick('http://invninjv1.local/recurring_invoices', event)
                            });
                        });
                    </script>

                    <a class='btn btn-primary' href='http://invninjv1.local/invoices/create'>New Invoice <span
                                class='glyphicon glyphicon-plus-sign'></span></a>

                </div>


                <table class="table table-striped data-table KwrKF7Jo">
                    <colgroup>
                        <col class="con0"/>
                        <col class="con1"/>
                        <col class="con2"/>
                    ...
                    <tr>
                        ...
                        <th align="center" valign="middle" class="head7"
                        >
                            Status
                        </th>
                        <th align="center" valign="middle" class="head8"
                        >
                ...
                <script type="text/javascript">
                    ...
                    function refreshDatatable_invoices() {
                        window['dataTable_invoices'].api().ajax.reload();
                    }

                    function load_KwrKF7Jo() {
                        window['dataTable_invoices'] = jQuery('.KwrKF7Jo').dataTable({
                            "stateSave": true,
                            "stateDuration": 0,
                            ...
                            "sPaginationType": "bootstrap",
                            "bProcessing": false,
                            "sAjaxSource": "http:\/\/invninjv1.local\/api\/invoices",
                            "bServerSide": true,
                            "aaSorting": [[3, "desc"]],
                            "fnDrawCallback": function (oSettings) {
                                if (window.onDatatableReady_invoices) {
                                    window.onDatatableReady_invoices();
            ...
            <style type="text/css">
                ...
                .listForm_invoice table.dataTable td:nth-child(5) {
                    text-align: right;
                }

                .listForm_invoice table.dataTable td:nth-child(6) {
                    text-align: right;
                }

                .listForm_invoice table.dataTable td:nth-child(8) {
                    text-align: center;
                }
            ...
            <script type="text/javascript">
                ...
                function submitForm_invoice(action, id) {
                    ...
                    if (id) {
                        $('#public_id_invoice').val(id);
                    }

                    if (action == 'delete' || action == 'emailInvoice') {
                        sweetConfirm(function () {
                            $('#action_invoice').val(action);
                            $('form.listForm_invoice').submit();
                        });
                    } else {
                        $('#action_invoice').val(action);
                        $('form.listForm_invoice').submit();
                ...
                $(function () {
                    ...
                    function filterTable_invoice(val) {
                        if (val == tableFilter) {
                            return;
                        }
                        tableFilter = val;
                        var oTable0 = $('.listForm_invoice .data-table').dataTable();
                    ...
                    $('#tableFilter_invoice').on('keyup', function () {
                        ...
                        searchTimeout = setTimeout(function () {
                            filterTable_invoice($('#tableFilter_invoice').val());
                        }, 500);
                    })

                    if ($('#tableFilter_invoice').val()) {
                        filterTable_invoice($('#tableFilter_invoice').val());
                    }

                    $('.listForm_invoice .head0').click(function (event) {
                        if (event.target.type !== 'checkbox') {
                            $('.listForm_invoice .head0 input[type=checkbox]').click();
                        }
                    });

                    // Enable/disable bulk action buttons
                    window.onDatatableReady_invoices = function () {
                        $(':checkbox').click(function () {
                            setBulkActionsEnabled_invoice();
                            changeSumLabel();
                        });

                        $('.listForm_invoice tbody tr').unbind('click').click(function (event) {
                    ...
                    $('.listForm_invoice .archive, .invoice').prop('disabled', true);
                    $('.listForm_invoice .archive:not(.dropdown-toggle)').click(function () {
                        submitForm_invoice('archive');
                    });

                    $('.listForm_invoice .selectAll').click(function () {
                        $(this).closest('table').find(':checkbox:not(:disabled)').prop('checked', this.checked);
                    });

                    function setBulkActionsEnabled_invoice() {
                        var buttonLabel = "Archive";
                        var count = $('.listForm_invoice tbody :checkbox:checked').length;
                        $('.listForm_invoice button.archive, .listForm_invoice button.invoice').prop('disabled', !count);
                        if (count) {
                            buttonLabel += ' (' + count + ')';
                        }
                        $('.listForm_invoice button.archive').not('.dropdown-toggle').text(buttonLabel);
                    }
                    ...
                    function changeSumLabel() {
                        var dTable = $('.listForm_invoice .data-table').DataTable();
                        ...
                        if (sum) {
                            $('#sum_column_invoice').show().text("Total: " + sum)
                        } else {
                            $('#sum_column_invoice').hide();
                        }

                    }

                    // Setup state/status filter
                    $('#statuses_invoice').select2({
                        placeholder: "Status",
                        //allowClear: true,
                        ...
                        .trigger('change')
                        .on('change', function () {
                            var filter = $('#statuses_invoice').val();
                            if (filter) {
                                filter = filter.join(',');
                            } else {
                                filter = '';
                            }
                            var url = 'http://invninjv1.local/set_entity_filter/invoice' + '/' + filter;
                            $.get(url, function (data) {
                                refreshDatatable_invoices();
                            })
                        }).maximizeSelect2Height();

                    $('#statusWrapper_invoice').show();
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="https://github.com/invoiceninja/invoiceninja/releases" target="_blank"
                       title="Trello Roadmap">v4.5.19</a> |
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                         data-src="/images/pro_plan/white_label_before.png" width="100%"
                                                         alt="before">
                                                </div>
                                                <div class="col-md-6">
                                                    <h4>After</h4>
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                         data-src="/images/pro_plan/white_label_after.png" width="100%"
                                                         alt="after">
                                                </div>
                                            </div>
                                            <br/>
                                ...
                                <div class="modal-footer" id="signUpFooter" style="margin-top: 0px">
                                    ...
                                    <button type="button" class="btn btn-primary" onclick="showApplyLicense()">Apply
                                    </button>
                                    <button type="button" class="btn btn-success" onclick="buyWhiteLabel()">Purchase
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="applyWhiteLabelModal" tabindex="-1" role="dialog"
                         aria-labelledby="applyWhiteLabelModal" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                                        ...
                                        <div class="panel-body">
                                            <form accept-charset="utf-8" class="form-horizontal" method="POST">
                                                ...
                                                <input type="hidden" name="_token"
                                                       value="IH4RfjHyCuiL4BTW0mJXyy0httbYIu2gFF50M3a6"></form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer" id="signUpFooter" style="margin-top: 0px">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                    <button type="button" class="btn btn-success" onclick="applyLicense()">Submit
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="recoverWhiteLabelModal" tabindex="-1" role="dialog"
                         aria-labelledby="recoverWhiteLabelModal" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">
                            ...
                            <div class="panel-body">
                                <div class="input-div">
                                    <div class="form-group required"><label for="" class="control-label">From</label>
                                        <div required class="form-control-static" id="contact_us_from">Norman Osborn
                                            &lt;norman@rideafide.local&gt;
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox"><label for="include_errors" class=""><input type="hidden"
                                                        ...
                                                        value="1">Include <a href="/errors" target="_blank">recent
                                                    errors</a> from storage/logs/laravel-error.log</label></div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="logoutModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-danger" onclick="logout(true)">Log Out/Delete company
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href="https://invoice-ninja.readthedocs.io/en/latest/invoices.html#list-invoices"
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('http://invninjv1.local/invoices' != settingsURL) {
