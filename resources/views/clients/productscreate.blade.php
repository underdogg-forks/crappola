...
<head>
    ...
    <title>Add Product | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/products/create"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <form accept-charset="utf-8" class="form-horizontal col-lg-10 col-lg-offset-1 main-form warn-on-exit"
                  autocomplete="off" method="POST" action="/products">

    
    <span style="display:none">
        <div class="form-group"><label for="public_id" class="control-label col-lg-4 col-sm-4">public id</label><div
                    class="col-lg-8 col-sm-8"><input class="form-control" id="public_id" type="text"
                                                     name="public_id"></div></div>
        <div class="form-group"><label for="action" class="control-label col-lg-4 col-sm-4">Action</label><div
                    class="col-lg-8 col-sm-8"><input class="form-control" id="action" type="text"
                                                     name="action"></div></div>
    </span>
                    ...
                    <div class="col-lg-10 col-lg-offset-1">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body form-padding-right">
                                ...
                                <div class="form-group required"><label for="product_key"
                                                                        class="control-label col-lg-4 col-sm-4">Product</label>
                                    <div class="col-lg-8 col-sm-8"><input required maxlength="255" class="form-control"
                                                                          id="product_key" type="text"
                                                                          name="product_key"></div>
                                </div>
                                <div class="form-group"><label for="notes"
                                                               class="control-label col-lg-4 col-sm-4">Notes</label>
                                    <div class="col-lg-8 col-sm-8"><textarea class="form-control" rows="6" id="notes"
                                                                             name="notes"></textarea></div>
                                </div>


                                <div class="form-group"><label for="cost"
                                                               class="control-label col-lg-4 col-sm-4">Cost</label>
                                    <div class="col-lg-8 col-sm-8"><input class="form-control" id="cost" type="text"
                                                                          name="cost"></div>
                                </div>
                ...
                <center class="buttons">
                    <a class='btn btn-default btn-lg' href='http://invninjv1.local/invoices'>Cancel <span
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('http://invninjv1.local/products/create' != settingsURL) {
