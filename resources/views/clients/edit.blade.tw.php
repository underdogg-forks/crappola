...
@if ($errors->first('contacts'))
    <div class="relative px-3 py-3 mb-4 border rounded text-red-darker border-red-dark bg-red-lighter">{{ trans($errors->first('contacts')) }}</div>
@endif
            ...
            <div class="panel-body">
				...
				<div class="tab-content" style="padding-top:24px;">
					<div role="tabpanel" class="tab-pane active" id="billing_address">
						...
						<div class="mb-4" id="copyShippingDiv" style="display:none;">
							<label for="city" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4"></label>
					...
					<div role="tabpanel" class="tab-pane" id="shipping_address">
						...
						<div class="mb-4" id="copyBillingDiv" style="display:none;">
							<label for="city" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4"></label>
							<div class="lg:w-2/3 pr-4 pl-4 sm:w-2/3 pr-4 pl-4">
        ...
        <div class="panel panel-default" style="min-height: 380px">
          <div class="panel-heading">
			...
			<div data-bind='template: { foreach: contacts,
				...
				<div class="mb-4">
					<div class="lg:w-2/3 pr-4 pl-4 col-lg-offset-4 bold">
