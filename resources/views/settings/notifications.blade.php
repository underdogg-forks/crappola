...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Notifications | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/notifications"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Settings &gt; Email Notifications"
            href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#email-notifications" target="_blank">
...
<div class="row">
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">Products</a>
                                                                                                <a href="/settings/notifications" class="list-group-item selected"
    ...
    <div class="panel-body">
        <div class="form-group"><label for="notify_sent" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="notify_sent" class=""><input type="hidden" name="notify_sent" value="0"><input id="notify_sent" type="checkbox" name="notify_sent" checked="checked" value="1">Email me when an invoice is <b>sent</b></label></div></div></div>
        <div class="form-group"><label for="notify_viewed" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="notify_viewed" class=""><input type="hidden" name="notify_viewed" value="0"><input id="notify_viewed" type="checkbox" name="notify_viewed" value="1">Email me when an invoice is <b>viewed</b></label></div></div></div>
        <div class="form-group"><label for="notify_paid" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="notify_paid" class=""><input type="hidden" name="notify_paid" value="0"><input id="notify_paid" type="checkbox" name="notify_paid" checked="checked" value="1">Email me when an invoice is <b>paid</b></label></div></div></div>
        <div class="form-group"><label for="notify_approved" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="notify_approved" class=""><input type="hidden" name="notify_approved" value="0"><input id="notify_approved" type="checkbox" name="notify_approved" checked="checked" value="1">Email me when a quote is <b>approved</b></label></div></div></div>
	...
	<div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
			...
			<div class="form-group"><label for="slack_webhook_url" class="control-label col-lg-4 col-sm-4">Webhook URL</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="slack_webhook_url" type="url" name="slack_webhook_url"><span class="help-block">Receive payment notifications using <a href="https://my.slack.com/services/new/incoming-webhook/" target="_blank">Slack incoming webhooks</a>.</span></div></div>
	...
	<div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="panel-body">
			...
			<div class="form-group"><label for="analytics_key" class="control-label col-lg-4 col-sm-4">Analytics Key</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="analytics_key" type="text" name="analytics_key"><span class="help-block">Track payments using <a href="https://support.google.com/analytics/answer/1037249?hl=en" target="_blank">Google Analytics Ecommerce</a></span></div></div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#email-notifications" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/notifications' != settingsURL) {
