...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Credit Cards &amp; Banks | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/bank_accounts"/>
...
<div class="row">
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">Templates &amp; Reminders</a>
                                                                                                <a href="/settings/bank_accounts" class="list-group-item selected"
    ...
    <div class="alert alert-warning">Note: accepting online payments requires a payment gateway, <a href="/gateways/create">click here</a> to add one.</div>

    <div class="pull-right">
        <a class='btn btn-default' href='http://invninjv1.local/bank_accounts/import_ofx'>Import OFX <span class='glyphicon glyphicon-open'></span></a>
        <a class='btn btn-primary' href='http://invninjv1.local/bank_accounts/create'>Add Bank company <span class='glyphicon glyphicon-plus-sign'></span></a>
    </div>

<div style="display:none">
    <form accept-charset="utf-8" class="form-horizontal bulk-form bulk-bank_account-form" method="POST" action="/bank_accounts/bulk">
...
<script type="text/javascript">
    function submitForm_bank_account(action, id) {
        if (action == 'delete') {
        ...
        $('form.bulk-bank_account-form').submit();
    }
</script>

<table class="table table-striped data-table Pev1ugVy">
    <colgroup>
                <col class="con0" />
                <col class="con1" />
                <col class="con2" />
...
<script type="text/javascript">
    ...
    function load_Pev1ugVy() {
        window['dataTable'] = jQuery('.Pev1ugVy').dataTable({
            "stateSave": true,
            "stateDuration": 0,
            ...
            "aoColumnDefs": [
                    ...
                    'aTargets': []
                        ...
                        "sPaginationType": "bootstrap",
                        "bProcessing": false,
                        "sAjaxSource": "http:\/\/invninjv1.local\/api\/bank_accounts",
                        "bServerSide": true,
                        "bFilter": false,
                        "bAutoWidth": false,
                        "aoColumns": [{"sWidth":"50%"},{"sWidth":"30%"},{"sWidth":"20%"}],
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/bank_accounts' != settingsURL) {
