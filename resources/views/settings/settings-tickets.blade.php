...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Ticket Settings | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/tickets"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Tickets "
            href="https://invoice-ninja.readthedocs.io/en/latest/tickets.html" target="_blank">
    ...
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">Credit Cards &amp; Banks</a>
                                                                                                <a href="/settings/tickets" class="list-group-item selected"
            ...
            <div class="col-md-12">
                ...
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        <li role="presentation" class="active"><a href="#defaults" aria-controls="notes" role="tab" data-toggle="tab">Defaults</a></li>
                        <li role="presentation"><a href="#domain" aria-controls="terms" role="tab" data-toggle="tab">Domain</a></li>
                        <li role="presentation"><a href="#attachments" aria-controls="footer" role="tab" data-toggle="tab">Attachments</a></li>
                        <li role="presentation"><a href="#notifications" aria-controls="footer" role="tab" data-toggle="tab">Notifications</a></li>
                        <li role="presentation"><a href="#templates" aria-controls="footer" role="tab" data-toggle="tab">Templates</a></li>
                    </ul>
                    ...
                    <div class="tab-content panel">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="defaults" >
                            <div class="panel-body form-padding-right">
                                ...
                                <div class="form-group"><label for="ticket_number_start" class="control-label col-lg-4 col-sm-4">Counter</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="ticket_number_start" type="text" name="ticket_number_start" value="1"><span class="help-block">Ticket number must be greater than the current ticket number</span></div></div>

                                <div id="">
                                    <div class="form-group"><label for="default_priority" class="control-label col-lg-4 col-sm-4">Default priority</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Default priority" id="default_priority" name="default_priority"><option value="10">Low</option><option value="20">Medium</option><option value="30">High</option></select></div></div>
                                </div>

                                <div id="">
                                    <div class="form-group"><label for="ticket_master_id" class="control-label col-lg-4 col-sm-4">Ticket Master</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Ticket Master" id="ticket_master_id" name="ticket_master_id"><option value="1" selected="selected">Norman Osborn</option></select><span class="help-block">Has the ability to assign and transfer tickets. Assigned as the default agent for all tickets.</span></div></div>
                                </div>

                                <div id="">
                                    <div class="form-group"><label for="default_agent_id" class="control-label col-lg-4 col-sm-4">Default Agent</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Default Agent" id="default_agent_id" name="default_agent_id"><option value="0"></option><option value="1">Norman Osborn</option></select><span class="help-block">If selected will automatically be assigned to all inbound tickets</span></div></div>
                                </div>

                                <div id="">
                                    <div class="form-group"><label for="allow_inbound_email_tickets_external" class="control-label col-lg-4 col-sm-4">New Tickets by email (Client)</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="allow_inbound_email_tickets_external" class=""><input type="hidden" name="allow_inbound_email_tickets_external" value="0"><input id="allow_inbound_email_tickets_external" type="checkbox" name="allow_inbound_email_tickets_external" checked="checked" value="1">Enable</label></div><span class="help-block">Allow clients to create new tickets by email</span></div></div>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="domain" >
                                <div class="panel-body form-padding-right" >
                                    ...
                                    <div class="form-group"><label for="support_email_local_part" class="control-label col-lg-4 col-sm-4">Local Part</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" placeholder="YOUR_NAME" id="support_email_local_part" type="text" name="support_email_local_part"><span class="input-group-btn"><button type='button' class='btn btn-info' onclick='checkSupportEmail()'>Search</button></span></div><span class="help-block">Customize the local part of your inbound support email, ie. YOUR_NAME@support.invoiceninja.com</span></div></div>


                                    <div class="form-group"><label for="from_name" class="control-label col-lg-4 col-sm-4">From Name</label><div class="col-lg-8 col-sm-8"><input class="form-control" placeholder="Support Center" id="from_name" type="text" name="from_name" value=""><span class="help-block">From name is the recognizable sender which is displayed instead of the email address, ie Support Center</span></div></div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="attachments" >
                            <div class="panel-body form-padding-right" >
                                ...
                                <div class="form-group"><label for="client_upload" class="control-label col-lg-4 col-sm-4">Client uploads</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="client_upload" class=""><input type="hidden" name="client_upload" value="0"><input id="client_upload" type="checkbox" name="client_upload" checked="checked" value="1">Enable</label></div><span class="help-block">Allow clients to upload documents/attachments</span></div></div>

                                <div id="max_file_size">
                                    <div class="form-group"><label for="max_file_size" class="control-label col-lg-4 col-sm-4">Maximum file size</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Maximum file size" id="max_file_size" name="max_file_size"><optgroup label="0"><option value="160">160</option></optgroup><optgroup label="1"><option value="320">320</option></optgroup><optgroup label="2"><option value="640">640</option></optgroup><optgroup label="3"><option value="1280">1280</option></optgroup><optgroup label="4"><option value="2560">2560</option></optgroup><optgroup label="5"><option value="5120">5120</option></optgroup><optgroup label="6"><option value="10240">10240</option></optgroup><optgroup label="7"><option value="20480">20480</option></optgroup></select><span class="help-block">Maximum file size (KB) is limited by your post_max_size and upload_max_filesize variables as set in your PHP.INI</span></div></div>
                                </div>


                                <div class="form-group"><label for="mime_types" class="control-label col-lg-4 col-sm-4">Mime types</label><div class="col-lg-8 col-sm-8"><input class="form-control" placeholder=".pdf , .docx, .jpg" id="mime_types" type="text" name="mime_types" value=""><span class="help-block">Comma separated list of allowed mime types, leave blank for all</span></div></div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="notifications" >
                            <div class="panel-body form-padding-right" >
                                ...
                                <div id="">
                                    <div class="form-group"><label for="new_ticket_template_id" class="control-label col-lg-4 col-sm-4">New ticket</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="New ticket" id="new_ticket_template_id" name="new_ticket_template_id"><option value="0"></option></select><span class="help-block">Selecting a template will send an auto response to a client/contact when a new ticket is created</span></div></div>
                                </div>

                                <div id="">
                                    <div class="form-group"><label for="update_ticket_template_id" class="control-label col-lg-4 col-sm-4">Updated ticket</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Updated ticket" id="update_ticket_template_id" name="update_ticket_template_id"><option value="0"></option></select><span class="help-block">Selecting a template will send an auto response to a client/contact when a ticket is updated</span></div></div>
                                </div>

                                <div id="">
                                    <div class="form-group"><label for="close_ticket_template_id" class="control-label col-lg-4 col-sm-4">Closed ticket</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Closed ticket" id="close_ticket_template_id" name="close_ticket_template_id"><option value="0"></option></select><span class="help-block">Selecting a template will send an auto response to a client/contact when a ticket is closed</span></div></div>
                                </div>

                                <div id="">
                                    <div class="form-group"><label for="alert_new_comment_id" class="control-label col-lg-4 col-sm-4">New comment</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="New comment" id="alert_new_comment_id" name="alert_new_comment_id"><option value="0"></option></select><span class="help-block">Selecting a template will send a notification (to agent) when a comment is made.</span></div></div>
                                </div>

                                <div class="form-group"><label for="alert_new_comment_id_email" class="control-label col-lg-4 col-sm-4">Additional new comment notifications</label><div class="col-lg-8 col-sm-8"><input class="form-control" placeholder="admin@example.com, supervisor@example.com" id="alert_new_comment_id_email" type="text" name="alert_new_comment_id_email" value=""><span class="help-block">Comma separated emails to bcc on new comment.</span></div></div>

                                <div id="">
                                    <div class="form-group"><label for="alert_ticket_assign_agent_id" class="control-label col-lg-4 col-sm-4">Ticket assignment</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Ticket assignment" id="alert_ticket_assign_agent_id" name="alert_ticket_assign_agent_id"><option value="0"></option></select><span class="help-block">Selecting a template will send a notification (to agent) when a ticket is assigned.</span></div></div>
                                </div>

                                <div class="form-group"><label for="alert_ticket_assign_email" class="control-label col-lg-4 col-sm-4">Additional ticket assigned notifications</label><div class="col-lg-8 col-sm-8"><input class="form-control" placeholder="admin@example.com, supervisor@example.com" id="alert_ticket_assign_email" type="text" name="alert_ticket_assign_email" value=""><span class="help-block">Comma separated emails to bcc on ticket assignment.</span></div></div>

                                <div id="">
                                    <div class="form-group"><label for="alert_ticket_overdue_agent_id" class="control-label col-lg-4 col-sm-4">Ticket overdue</label><div class="col-lg-8 col-sm-8"><select class="form-control" text="Ticket overdue" id="alert_ticket_overdue_agent_id" name="alert_ticket_overdue_agent_id"><option value="0"></option></select><span class="help-block">Selecting a template will send a notification (to agent) when a ticket becomes overdue.</span></div></div>
                                </div>

                                <div class="form-group"><label for="alert_ticket_overdue_email" class="control-label col-lg-4 col-sm-4">Additional overdue ticket notifications</label><div class="col-lg-8 col-sm-8"><input class="form-control" placeholder="admin@example.com, supervisor@example.com" id="alert_ticket_overdue_email" type="text" name="alert_ticket_overdue_email" value=""><span class="help-block">Comma separated emails to bcc on ticket overdue.</span></div></div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="templates" >
                            <div class="panel-body form-padding-right" >
                                <a class='btn btn-primary pull-right' href='http://invninjv1.local/ticket_templates/create'>Add Template <span class='glyphicon glyphicon-plus-sign'></span></a>

                                <div style="display:none">
    <form accept-charset="utf-8" class="form-horizontal bulk-form bulk-ticket_template-form" method="POST" action="/ticket_templates/bulk">
    <div class="form-group"><label for="bulk_action" class="control-label col-lg-4 col-sm-4">bulk action</label><div class="col-lg-8 col-sm-8"><input class="bulk-action form-control" id="bulk_action" type="text" name="bulk_action"></div></div>
    <div class="form-group"><label for="bulk_public_id" class="control-label col-lg-4 col-sm-4">bulk public id</label><div class="col-lg-8 col-sm-8"><input class="bulk-public-id form-control" id="bulk_public_id" type="text" name="bulk_public_id"></div></div>
    <input type="hidden" name="_token" value="IH4RfjHyCuiL4BTW0mJXyy0httbYIu2gFF50M3a6"></form>
</div>

<script type="text/javascript">
    function submitForm_ticket_template(action, id) {
        if (action == 'delete') {
        ...
        $('form.bulk-ticket_template-form').submit();
    }
</script>

                                <table class="table table-striped data-table wD9maaZ2">
    <colgroup>
                <col class="con0" />
                <col class="con1" />
                <col class="con2" />
...
<script type="text/javascript">
    ...
    function load_wD9maaZ2() {
        window['dataTable'] = jQuery('.wD9maaZ2').dataTable({
            "stateSave": true,
            "stateDuration": 0,
            ...
            "aoColumnDefs": [
                    ...
                    'aTargets': []
                        ...
                        "sPaginationType": "bootstrap",
                        "bProcessing": false,
                        "sAjaxSource": "http:\/\/invninjv1.local\/api\/ticket_templates",
                        "bServerSide": true,
                        "bFilter": false,
                        "bAutoWidth": false,
            ...
            "stateLoadParams": function (settings, data) {
                ...
                <center>
                    <button type='submit' class='btn btn-success btn-lg' id='saveButton'>Save <span class='glyphicon glyphicon-floppy-disk'></span></button>
                </center>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/tickets.html" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/tickets' != settingsURL) {
