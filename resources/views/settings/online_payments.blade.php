...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Online Payments | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/online_payments"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Settings &gt; Online Payments"
            href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#online-payments" target="_blank">
...
<div class="row">
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">Localization</a>
                                                                                                <a href="/settings/online_payments" class="list-group-item selected"
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group"><label for="token_billing_type_id" class="control-label col-lg-4 col-sm-4">Token Billing</label><div class="col-lg-8 col-sm-8"><select class="form-control" id="token_billing_type_id" name="token_billing_type_id"><option value="1">Disabled</option><option value="2">Opt-in - checkbox is shown but not selected</option><option value="3">Opt-out - checkbox is shown and selected</option><option value="4" selected="selected">Always</option></select><span class="help-block">Store payment details with WePay, Stripe, Braintree or GoCardless.</span></div></div>

            <div class="form-group"><label for="auto_bill_on_due_date" class="control-label col-lg-4 col-sm-4">Auto Bill</label><div class="col-lg-8 col-sm-8"><label for="auto_bill_on_due_date2" class="radio-inline"><input value="0" id="auto_bill_on_due_date2" type="radio" name="auto_bill_on_due_date" checked="checked">On send date</label><label for="auto_bill_on_due_date3" class="radio-inline"><input value="1" id="auto_bill_on_due_date3" type="radio" name="auto_bill_on_due_date">On due date</label><span class="help-block">ACH will always auto bill on the due date.</span></div></div>

			<div class="form-group"><label for="gateway_fee_enabled" class="control-label col-lg-4 col-sm-4">Gateway Fees</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="gateway_fee_enabled" class=""><input type="hidden" name="gateway_fee_enabled" value="0"><input id="gateway_fee_enabled" type="checkbox" name="gateway_fee_enabled" value="1">Enable</label></div><span class="help-block">Automatically add an online payment surcharge/discount.</span></div></div>

			<div class="form-group"><label for="send_item_details" class="control-label col-lg-4 col-sm-4">Item Details</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="send_item_details" class=""><input type="hidden" name="send_item_details" value="0"><input id="send_item_details" type="checkbox" name="send_item_details" value="1">Enable</label></div><span class="help-block">Send line item details to the payment gateway.</span></div></div>

			<br/>
            <div class="form-group"><div class="col-lg-offset-4 col-sm-offset-4 col-lg-8 col-sm-8"><button type='submit' class='btn btn-success' id='formSave'>Save <span class='glyphicon glyphicon-floppy-disk'></span></button></div></div>
        </div>
    </div>

    <input type="hidden" name="_token" value="IH4RfjHyCuiL4BTW0mJXyy0httbYIu2gFF50M3a6"></form>

        <a class='btn btn-primary pull-right' href='http://invninjv1.local/gateways/create'>Add Gateway <span class='glyphicon glyphicon-plus-sign'></span></a>
  
  <div style="display:none">
    <form accept-charset="utf-8" class="form-horizontal bulk-form bulk-account_gateway-form" method="POST" action="/account_gateways/bulk">
...
<script type="text/javascript">
    function submitForm_account_gateway(action, id) {
        if (action == 'delete') {
        ...
        $('form.bulk-account_gateway-form').submit();
    }
</script>

  <table class="table table-striped data-table 40wMM3Iu">
    <colgroup>
                <col class="con0" />
                <col class="con1" />
                <col class="con2" />
...
<script type="text/javascript">
    ...
    function load_40wMM3Iu() {
        window['dataTable'] = jQuery('.40wMM3Iu').dataTable({
            "stateSave": true,
            "stateDuration": 0,
            ...
            "aoColumnDefs": [
                    ...
                    'aTargets': []
                        ...
                        "sPaginationType": "bootstrap",
                        "bProcessing": false,
                        "sAjaxSource": "http:\/\/invninjv1.local\/api\/gateways",
                        "bServerSide": true,
                        "bFilter": false,
                        "bAutoWidth": false,
                        "aoColumns": [{"sWidth":"20%"},{"sWidth":"20%"},{"sWidth":"30%"},{"sWidth":"20%"}],
    ...
    <form accept-charset="utf-8" class="form-horizontal" method="POST" action="/settings/payment_gateway_limits">
					...
					<div role="tabpanel">
		                <ul class="nav nav-tabs" role="tablist" style="border: none">
		                    <li role="presentation" class="active">
		                        <a href="#limits" aria-controls="limits" role="tab" data-toggle="tab">Limits</a>
		                    </li>
		                    <li role="presentation">
		                        <a href="#fees" aria-controls="fees" role="tab" data-toggle="tab">Fees</a>
		                    </li>
		                </ul>
		            </div>
		            <div class="tab-content">
			                    ...
			                    <div class="row">
			                        <div class="col-md-6">
			                            <div id="payment-limit-min-container">
			                                <label for="payment-limit-min">Min</label><br>
			                                ...
			                                <label><input type="checkbox" id="payment-limit-min-enable"
			                                              name="limit_min_enable"> Enable min</label>
			                            </div>
			                        </div>
			                        <div class="col-md-6">
			                            <div id="payment-limit-max-container">
			                                <label for="payment-limit-max">Max</label><br>
			                                ...
			                                <label><input type="checkbox" id="payment-limit-max-enable"
			                                              name="limit_max_enable"> Enable max</label>
			                            </div>
			                        </div>
			                    </div>
						...
						<div role="tabpanel" class="tab-pane" id="fees">
		                    ...
		                    <div id="feesEnabled" class="panel-body">
								...
								<div class="form-group"><label for="fee_amount" class="control-label col-lg-4 col-sm-4">Amount</label><div class="col-lg-8 col-sm-8"><input class="form-control" onchange="updateFeeSample()" step="any" id="fee_amount" type="number" name="fee_amount"></div></div>

								<div class="form-group"><label for="fee_percent" class="control-label col-lg-4 col-sm-4">Percent</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" onchange="updateFeeSample()" step="any" id="fee_percent" type="number" name="fee_percent"><span class="input-group-addon">%</span></div></div></div>

								<div class="form-group"><label for="adjust_fee_percent" class="control-label col-lg-4 col-sm-4"> </label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="adjust_fee_percent" class=""><input type="hidden" name="adjust_fee_percent" value="0"><input onchange="updateFeeSample()" id="adjust_fee_percent" type="checkbox" name="adjust_fee_percent" value="1">Adjust percent to company for fee</label></div></div></div>

								<div class="form-group"><label for="fee_cap" class="control-label col-lg-4 col-sm-4">Maximum</label><div class="col-lg-8 col-sm-8"><input class="form-control" onchange="updateFeeSample()" step="any" id="fee_cap" type="number" name="fee_cap"></div></div>

								
								<div style="display:none">
									<div class="form-group"><label for="fee_tax_name1" class="control-label col-lg-4 col-sm-4">fee tax name1</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="fee_tax_name1" type="text" name="fee_tax_name1"></div></div>
									<div class="form-group"><label for="fee_tax_rate1" class="control-label col-lg-4 col-sm-4">fee tax rate1</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="fee_tax_rate1" type="text" name="fee_tax_rate1"></div></div>
									<div class="form-group"><label for="fee_tax_name2" class="control-label col-lg-4 col-sm-4">fee tax name2</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="fee_tax_name2" type="text" name="fee_tax_name2"></div></div>
									<div class="form-group"><label for="fee_tax_rate2" class="control-label col-lg-4 col-sm-4">fee tax rate2</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="fee_tax_rate2" type="text" name="fee_tax_rate2"></div></div>
								</div><br/>
								...
								<br/><b>Warning: not all states/payment gateways allow adding fees, please review local laws/terms of service.</b>
  ...
  <script>
	...
	function showLimitsModal(gateway_type, gateway_type_id) {
        ...
        var modalLabel = "Set :gateway_type Limits\/Fees";
	...
	function updateFeeSample() {
		...
		if (total >= 0) {
			var str = "The fee for a :amount invoice would be :total.";
		} else {
			var str = "The discount for a :amount invoice would be :total.";
		}
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#online-payments" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/online_payments' != settingsURL) {
