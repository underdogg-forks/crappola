...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Email Settings | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/email_settings"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Email Settings "
            href="https://invoice-ninja.readthedocs.io/en/latest/email_settings.html" target="_blank">
...
<div class="row">
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">Client Portal</a>
                                                                                                <a href="/settings/email_settings" class="list-group-item selected"
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body form-padding-right">
            ...
            <div class="form-group"><label for="reply_to_email" class="control-label col-lg-4 col-sm-4">Reply-To Email</label><div class="col-lg-8 col-sm-8"><input class="form-control" placeholder="norman@rideafide.local" id="reply_to_email" type="email" name="reply_to_email"><span class="help-block">Specify the reply-to address for client emails.</span></div></div>

            <div class="form-group"><label for="bcc_email" class="control-label col-lg-4 col-sm-4">BCC Email</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="bcc_email" type="email" name="bcc_email"><span class="help-block">Privately include this address with client emails.</span></div></div>

            &nbsp;

            <div class="form-group"><label for="pdf_email_attachment" class="control-label col-lg-4 col-sm-4">Attach PDF</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="pdf_email_attachment" class=""><input type="hidden" name="pdf_email_attachment" value="0"><input id="pdf_email_attachment" type="checkbox" name="pdf_email_attachment" value="1">Enable</label></div><span class="help-block">In certain cases the app uses <a href="https://phantomjscloud.com/" target="_blank">phantomjscloud.com</a> to generate the PDF, install <a href="https://invoice-ninja.readthedocs.io/en/latest/configure.html#phantomjs" target="_blank">PhantomJS</a> to generate it locally. | <a href="/test_headless" target="_blank">Test</a></span></div></div>

            <div class="form-group"><label for="document_email_attachment" class="control-label col-lg-4 col-sm-4">Attach Documents</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="document_email_attachment" class=""><input type="hidden" name="document_email_attachment" value="0"><input id="document_email_attachment" type="checkbox" name="document_email_attachment" value="1">Enable</label></div></div></div>

            <div class="form-group"><label for="ubl_email_attachment" class="control-label col-lg-4 col-sm-4">Attach UBL [Beta]</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="ubl_email_attachment" class=""><input type="hidden" name="ubl_email_attachment" value="0"><input id="ubl_email_attachment" type="checkbox" name="ubl_email_attachment" value="1">Enable</label></div></div></div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body form-padding-right">
            ...
            <div class="form-group email_design_id"><label for="email_design_id" class="control-label col-lg-4 col-sm-4">Email Style</label><div class="col-lg-8 col-sm-8"><div class="input-group"><select class="form-control" id="email_design_id" name="email_design_id"><option value="1" selected="selected">Plain</option><option value="2">Light</option><option value="3">Dark</option></select><span class="input-group-addon"><span class="glyphicon glyphicon-question-sign"></span></span></div><span class="help-block">Make your emails look more professional with HTML layouts.</span></div></div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <textarea class="form-control" style="display:none" id="email_footer" name="email_footer"></textarea>
    ...
    <div class="modal fade" id="designHelpModal" tabindex="-1" role="dialog" aria-labelledby="designHelpModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="min-width:150px">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="designHelpModalLabel">Email Designs</h4>
                </div>
                ...
                <div class="panel-body">
                    <div class="row" style="text-align:center">
                        <div class="col-md-4">
                            <h4>Plain</h4><br/>
                            <img src="/images/emails/plain.png" class="img-responsive"/>
                        </div>
                        <div class="col-md-4">
                            <h4>Light</h4><br/>
                            <img src="/images/emails/light.png" class="img-responsive"/>
                        </div>
                        <div class="col-md-4">
                            <h4>Dark</h4><br/>
                            <img src="/images/emails/dark.png" class="img-responsive"/>
                        </div>
                    </div>
                </div>
                </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/email_settings.html" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/email_settings' != settingsURL) {
