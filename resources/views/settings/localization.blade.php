    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="panel-heading">
                ...
                <div class="form-group"><label for="start_of_week" class="control-label col-lg-4 col-sm-4">First Day of the Week</label><div class="col-lg-8 col-sm-8"><select class="form-control" id="start_of_week" name="start_of_week"><option value=""></option><option value="0" selected="selected">Sunday</option><option value="1">Monday</option><option value="2">Tuesday</option><option value="3">Wednesday</option><option value="4">Thursday</option><option value="5">Friday</option><option value="6">Saturday</option></select><span class="help-block">Used by <b>date</b> selectors</span></div></div>

                <div class="form-group"><label for="financial_year_start" class="control-label col-lg-4 col-sm-4">First Month of the Year</label><div class="col-lg-8 col-sm-8"><select class="form-control" id="financial_year_start" name="financial_year_start"><option value=""></option><option value="2000-01-01">January</option><option value="2000-02-01">February</option><option value="2000-03-01">March</option><option value="2000-04-01">April</option><option value="2000-05-01">May</option><option value="2000-06-01">June</option><option value="2000-07-01">July</option><option value="2000-08-01">August</option><option value="2000-09-01">September</option><option value="2000-10-01">October</option><option value="2000-11-01">November</option><option value="2000-12-01">December</option></select><span class="help-block">Used by <b>date range</b> selectors</span></div></div>
