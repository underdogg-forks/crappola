	...
	<div class="row">
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <div class="panel-body form-padding-right">
                ...
                <div class="form-group required"><label for="name" class="control-label col-lg-4 col-sm-4">Name</label><div class="col-lg-8 col-sm-8"><input required class="form-control" id="name" type="text" name="name" value="Second company"></div></div>
                <div class="form-group"><label for="id_number" class="control-label col-lg-4 col-sm-4">ID Number</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="id_number" type="text" name="id_number" value="459846723"></div></div>
                <div class="form-group"><label for="vat_number" class="control-label col-lg-4 col-sm-4">VAT Number</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="vat_number" type="text" name="vat_number" value="456767345"></div></div>
                <div class="form-group"><label for="website" class="control-label col-lg-4 col-sm-4">Website</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="website" type="text" name="website" value=""></div></div>
				                	<div class="form-group"><label for="work_email" class="control-label col-lg-4 col-sm-4">Email</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="work_email" type="text" name="work_email" value=""></div></div>
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            ...
            <div class="form-group"><label for="address1" class="control-label col-lg-4 col-sm-4">Street</label><div class="col-lg-8 col-sm-8"><input class="form-control" autocomplete="address-line1" id="address1" type="text" name="address1" value=""></div></div>
            <div class="form-group"><label for="address2" class="control-label col-lg-4 col-sm-4">Apt/Suite</label><div class="col-lg-8 col-sm-8"><input class="form-control" autocomplete="address-line2" id="address2" type="text" name="address2" value=""></div></div>
            <div class="form-group"><label for="city" class="control-label col-lg-4 col-sm-4">City</label><div class="col-lg-8 col-sm-8"><input class="form-control" autocomplete="address-level2" id="city" type="text" name="city" value=""></div></div>
            <div class="form-group"><label for="state" class="control-label col-lg-4 col-sm-4">State/Province</label><div class="col-lg-8 col-sm-8"><input class="form-control" autocomplete="address-level1" id="state" type="text" name="state" value=""></div></div>
            <div class="form-group"><label for="postal_code" class="control-label col-lg-4 col-sm-4">Postal Code</label><div class="col-lg-8 col-sm-8"><input class="form-control" autocomplete="postal-code" id="postal_code" type="text" name="postal_code" value=""></div></div>
