...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Tax Rates | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/tax_rates"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Settings &gt; Tax Rates"
            href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#tax-rates" target="_blank">
...
<div class="row">
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">Online Payments</a>
                                                                                                <a href="/settings/tax_rates" class="list-group-item selected"
  ...
  <div class="panel-heading">
    <h3 class="panel-title">Tax Settings</h3>
  </div>
  <div class="panel-body">

    <div class="form-group"><label for="invoice_taxes" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="invoice_taxes" class=""><input type="hidden" name="invoice_taxes" value="0"><input id="invoice_taxes" type="checkbox" name="invoice_taxes" checked="checked" value="1">Enable specifying an <b>invoice tax</b></label></div></div></div>

    <div class="form-group"><label for="invoice_item_taxes" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="invoice_item_taxes" class=""><input type="hidden" name="invoice_item_taxes" value="0"><input id="invoice_item_taxes" type="checkbox" name="invoice_item_taxes" checked="checked" value="1">Enable specifying <b>line item taxes</b></label></div></div></div>

    <div class="form-group"><label for="enable_second_tax_rate" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="enable_second_tax_rate" class=""><input type="hidden" name="enable_second_tax_rate" value="0"><input id="enable_second_tax_rate" type="checkbox" name="enable_second_tax_rate" checked="checked" value="1">Enable specifying a <b>second tax rate</b></label></div></div></div>

    <div class="form-group"><label for="include_item_taxes_inline" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="include_item_taxes_inline" class=""><input type="hidden" name="include_item_taxes_inline" value="0"><input id="include_item_taxes_inline" type="checkbox" name="include_item_taxes_inline" checked="checked" value="1">Include <b>line item taxes in line total</b></label></div></div></div>

            <br/>
        <br/>
        <div class="form-group"><label for="inclusive_taxes" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="inclusive_taxes" class=""><input type="hidden" name="inclusive_taxes" value="0"><input id="inclusive_taxes" type="checkbox" name="inclusive_taxes" checked="checked" value="1">Include <b>taxes in the cost</b></label></div><span class="help-block"><b>IMPORTANT: This setting can not be changed once an invoice has been created.</b></span></div></div>
    
      &nbsp;

                <div class="form-group"><label for="tax_select1" class="control-label col-lg-4 col-sm-4">Default Tax Rate</label><div class="col-lg-8 col-sm-8"><select class="form-control" onchange="taxSelectChange(event)" id="tax_select1" name="tax_select1"><option value=""></option><option value="1">Domestic Low: 6.000%</option><option value="2">Domestic High: 21.000%</option></select></div></div>

<div style="display:none">
  <div class="form-group"><label for="tax_rate1" class="control-label col-lg-4 col-sm-4">Tax Rate 1</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="tax_rate1" type="input" name="tax_rate1" value="21.000"></div></div>
  <div class="form-group"><label for="tax_name1" class="control-label col-lg-4 col-sm-4">tax name1</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="tax_name1" type="input" name="tax_name1" value="Domestic High"></div></div>
</div>

<div style="display:block">
  <div class="form-group"><label for="tax_select2" class="control-label col-lg-4 col-sm-4">Default Tax Rate</label><div class="col-lg-8 col-sm-8"><select class="form-control" onchange="taxSelectChange(event)" id="tax_select2" name="tax_select2"><option value=""></option><option value="1">Domestic Low: 6.000%</option><option value="2">Domestic High: 21.000%</option></select></div></div>

  <div style="display:none">
      <div class="form-group"><label for="tax_rate2" class="control-label col-lg-4 col-sm-4">Tax Rate 2</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="tax_rate2" type="input" name="tax_rate2" value="21.000"></div></div>
      <div class="form-group"><label for="tax_name2" class="control-label col-lg-4 col-sm-4">tax name2</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="tax_name2" type="input" name="tax_name2" value="Domestic High"></div></div>
  </div>
</div>

<script type="text/javascript">

    var taxRates = [{"company_id":2,"user_id":2,"created_at":"2020-08-08 18:57:09","updated_at":"2020-08-08 18:57:09","deleted_at":null,"name":"Domestic Low","rate":"6.000","public_id":1,"is_inclusive":0},{"company_id":2,"user_id":2,"created_at":"2020-08-08 18:57:19","updated_at":"2020-08-08 18:57:19","deleted_at":null,"name":"Domestic High","rate":"21.000","public_id":2,"is_inclusive":0}];
  ...
  <a class='btn btn-primary pull-right' href='http://invninjv1.local/tax_rates/create'>Add Tax Rate <span class='glyphicon glyphicon-plus-sign'></span></a>

  <div style="display:none">
    <form accept-charset="utf-8" class="form-horizontal bulk-form bulk-tax_rate-form" method="POST" action="/tax_rates/bulk">
...
<script type="text/javascript">
    function submitForm_tax_rate(action, id) {
        if (action == 'delete') {
        ...
        $('form.bulk-tax_rate-form').submit();
    }
</script>

  <table class="table table-striped data-table FJ5VWxPy">
    <colgroup>
                <col class="con0" />
                <col class="con1" />
                <col class="con2" />
...
<script type="text/javascript">
    ...
    function load_FJ5VWxPy() {
        window['dataTable'] = jQuery('.FJ5VWxPy').dataTable({
            "stateSave": true,
            "stateDuration": 0,
            ...
            "aoColumnDefs": [
                    ...
                    'aTargets': []
                        ...
                        "sPaginationType": "bootstrap",
                        "bProcessing": false,
                        "sAjaxSource": "http:\/\/invninjv1.local\/api\/tax_rates",
                        "bServerSide": true,
                        "bFilter": false,
                        "bAutoWidth": false,
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#tax-rates" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/tax_rates' != settingsURL) {
