...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>User Management | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/settings/user_management"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: User Management "
            href="https://invoice-ninja.readthedocs.io/en/latest/user_management.html" target="_blank">
...
<div class="row">
    <div class="col-md-3">
                ...
                <div class="list-group">
                                ...
                                style="width:100%;text-align:left">API Tokens</a>
                                                                                                <a href="/settings/user_management" class="list-group-item selected"
    ...
    <div class="col-md-9">
                        ...
                        <div class="pull-right">
                <a class='btn btn-primary' href='http://invninjv1.local/users/create'>Add User <span class='glyphicon glyphicon-plus-sign'></span></a>
            </div>
  ...
  <div style="display:none">
    <form accept-charset="utf-8" class="form-horizontal bulk-form bulk-user-form" method="POST" action="/users/bulk">
...
<script type="text/javascript">
    function submitForm_user(action, id) {
        if (action == 'delete') {
        ...
        $('form.bulk-user-form').submit();
    }
</script>

  <table class="table table-striped data-table PkNfUvma">
    <colgroup>
                <col class="con0" />
                <col class="con1" />
                <col class="con2" />
...
<script type="text/javascript">
    ...
    function load_PkNfUvma() {
        window['dataTable'] = jQuery('.PkNfUvma').dataTable({
            "stateSave": true,
            "stateDuration": 0,
            ...
            "aoColumnDefs": [
                    ...
                    'aTargets': []
                        ...
                        "sPaginationType": "bootstrap",
                        "bProcessing": false,
                        "sAjaxSource": "http:\/\/invninjv1.local\/api\/users",
                        "bServerSide": true,
                        "bFilter": false,
                        "bAutoWidth": false,
                        "aoColumns": [{"sWidth":"20%"},{"sWidth":"45%"},{"sWidth":"20%"},{"sWidth":"15%"}],
  ...
  <script>
    ...
    function setTrashVisible() {
        ...
        var url = 'http://invninjv1.local/set_entity_filter/user' + (checked ? '/active,archived' : '/active');
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/user_management.html" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/settings/user_management' != settingsURL) {
