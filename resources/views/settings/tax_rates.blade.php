...
<script type="text/javascript">
  ...
  <table class="table table-striped data-table 4N9ZwpLY">
    <colgroup>
                <col class="con0" />
                <col class="con1" />
                <col class="con2" />
...
<script type="text/javascript">
    ...
    function load_4N9ZwpLY() {
        window['dataTable'] = jQuery('.4N9ZwpLY').dataTable({
            "stateSave": true,
            "stateDuration": 0,
