        ...
        <div class="container-fluid">
            ...
            <script type="text/javascript">
                ...
                var company = {
                    ...
                    "currency_id": 1,
                    "created_at": "2020-08-08 18:20:19",
                    "updated_at": "2020-08-08 18:24:37",
                    "deleted_at": null,
                    "name": null,
                    "account_key": "hcm2o7uvejuorwwsaqqxhjeigivwqwbo",
                    "last_login": "2020-08-08 18:24:37",
                    "address1": null,
                    "address2": null,
                    "city": null,
                    "state": null,
                    ...
                    "custom_messages": {},
                    "is_custom_domain": 0,
                    "allow_approve_expired_quote": 0,
                    "custom_fields_options": {},
                    "client_view_js": "",
                    "show_product_notes": 0,
                    "require_approve_quote": 1,
                    ...
                    "companyPlan": {
                        ...
                        "pending_term": null,
                        "created_at": "2020-08-08 18:20:19",
                        "updated_at": "2020-08-08 18:20:19",
                        "deleted_at": null,
                        "plan_price": null,
                        ...
                        "promo_expires": null,
                        "bluevine_status": null,
                        "referral_code": null,
                        "app_store_order_id": null
                    },
                    "language": {"id": 1, "name": "English", "locale": "en"},
                    "currency": {
                        "id": 1,
                        "name": "US Dollar",
                        "symbol": "$",
            ...
            <div class="row" id="dashboard-totals-in-all-currencies-help" style="display: none">
                <div class="col-xs-12">
                    <div class="alert alert-warning custom-message">Note: add a <a
                                href="/settings/invoice_settings#invoice_fields" target="_blank">Custom Field</a> named
                        "Exchange Rate" to show the totals using a single base currency.
                    </div>
                </div>
            </div>
                    ...
                    <div class="pull-right">
                        <div id="group-btn-group" class="btn-group" role="group"
                            ...
                            <button type="button" class="btn btn-normal active" data-button="day"
                                    style="font-weight:normal !important;background-color:white">Day
                            </button>
                            <button type="button" class="btn btn-normal" data-button="week"
                                    style="font-weight:normal !important;background-color:white">Week
                            </button>
                            <button type="button" class="btn btn-normal" data-button="month"
                                    style="font-weight:normal !important;background-color:white">Month
                            </button>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div id="signUpDiv" onkeyup="validateSignUp()" onclick="validateSignUp()"
                                ...
                                <form accept-charset="utf-8" class="form-horizontal signUpForm" autocomplete="off"
                                      method="POST" action="/signup/submit">
                                    ...
                                    <input type="hidden" name="_token" value="IH4RfjHyCuiL4BTW0mJXyy0httbYIu2gFF50M3a6">
                                </form>
