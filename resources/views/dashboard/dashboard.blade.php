...
@section('content')
    ...
    <script type="text/javascript">
        ...
        var realCurrencyId = {{ $company->getCurrencyId() }};
        var chartCurrencyId = {{ $company->getCurrencyId() }};
        var chartQuarter = moment().quarter();
        var dateRanges = {!! $company->present()->dateRangeOptions !!};
        var chartStartDate;
        var chartEndDate;
    ...
    <div class="row">
        ...
        @if (count($tasks))
            ...
            {{--@if ($company->companyPlan->hasEarnedPromo())
                                    ...
                                    <div class="in-bold">
                                        @if (count($paidToDate))
                                            ...
                                            <div class="currency currency_totals" style="display:none">
                                                {{ Utils::formatMoney($paidToDateTotal, $company->getCurrencyId()) }}
                                            </div>
                                        @else
                                ...
                                <div style="overflow:hidden">
                                    @if ($showExpenses)
                                        ...
                                        <div class="in-bold">
                                            ...
                                            @endforeach
                                            <div class="currency currency_totals" style="display:none">
                                                {{ Utils::formatMoney($expensesTotals, $company->getCurrencyId()) }}
                                                <br/>
                                            </div>
                                            <div class="currency currency_blank" style="display:none">
                                                &nbsp;
                                    ...
                                    @else
                                        ...
                                        <div class="in-bold">
                                            @if (count($averageInvoice))
                                                ...
                                                @endforeach
                                                <div class="currency currency_totals" style="display:none">
                                                    {{ Utils::formatMoney($averageInvoiceTotal, $company->getCurrencyId()) }}
                                                    <br/>
                                                </div>
                                            @else
                                                <div class="currency currency_{{ $company->getCurrencyId() }}"
                                ...
                                <div style="overflow:hidden">
                                    ...
                                    <div class="in-bold">
                                        @if (count($balances))
                                            ...
                                            @endforeach
                                            <div class="currency currency_totals" style="display:none">
                                                {{ Utils::formatMoney($balancesTotals, $company->getCurrencyId()) }}
                                                <br/>
                                            </div>
                                        @else
                                            <div class="currency currency_{{ $company->getCurrencyId() }}"
                        ...
                        <div class="panel-body" style="height:274px;overflow-y:auto;">
                            <table class="table table-striped">
                                ...
                                @foreach ($payments as $payment)
                                    <tr>
                                        <td>{!! Invoice::calcLink($payment) !!}</td>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach ($upcoming as $invoice)
                                    @if ($invoice->invoice_type_id == INVOICE_TYPE_STANDARD)
                                        <tr>
                                            <td>{!! Invoice::calcLink($invoice) !!}</td>
                                            ...
                                            @endcan
                                            <td>{{ Utils::fromSqlDate($invoice->due_at) }}</td>
