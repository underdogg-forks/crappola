...
@section('content')
	...
	<div class="container mx-auto" id="main-container">
		...
		<div id="top_right_buttons" class="pull-right">
			<input id="tableFilter" type="text" style="width:140px;margin-right:17px" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded pull-left" placeholder="{{ trans('texts.filter') }}"/>
		</div>
		-->
