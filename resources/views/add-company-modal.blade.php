...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Introduction &gt; Dashboard"
...
<script type="text/javascript">
                ...
                window.myChart = new Chart(ctx, {
                    ...
                    options: {
                        tooltips: {
                            ...
                            callbacks: {
                                title: function(item) {
                                    return moment(item[0].xLabel).format("MMM D, YYYY");
                                },
                                label: function(item, data) {
                                    ...
                                    return label + formatMoney(item.yLabel, realCurrencyId, company.country_id);
                                }
                            }
                        },
                        title: {
                            ...
                            yAxes: [{
                                ticks: {
                                    ...
                                    callback: function(label, index, labels) {
                                        return formatMoney(label, realCurrencyId, company.country_id);
                                    }
                                },
                            }]
                        }
        ...
        var company = {"id":1,"timezone_id":null,"date_format_id":null,"datetime_format_id":null,"currency_id":1,"created_at":"2020-08-08 18:20:19","updated_at":"2020-08-08 18:55:20","deleted_at":null,"name":"Localhost company","account_key":"hcm2o7uvejuorwwsaqqxhjeigivwqwbo","last_login":"2020-08-08 18:24:37","address1":"","address2":"","city":"","state":"","postal_code":"","country_id":null,"invoice_terms":null,"industry_id":14,"size_id":1,"invoice_taxes":1,"invoice_item_taxes":1,"invoice_design_id":1,"work_phone":"","work_email":"","language_id":1,"custom_value1":null,"custom_value2":null,"fill_products":1,"update_products":1,"primary_color":null,"secondary_color":null,"hide_quantity":0,"hide_paid_to_date":0,"custom_invoice_taxes1":null,"custom_invoice_taxes2":null,"vat_number":"54983458","invoice_number_prefix":null,"invoice_number_counter":1,"quote_number_prefix":null,"quote_number_counter":1,"share_counter":1,"id_number":"45986458","token_billing_type_id":4,"invoice_footer":null,"pdf_email_attachment":0,"subdomain":null,"font_size":9,"invoice_labels":null,"custom_design1":null,"show_item_taxes":0,"iframe_url":null,"military_time":0,"recurring_hour":8,"invoice_number_pattern":null,"quote_number_pattern":null,"quote_terms":null,"website":"","client_view_css":null,"header_font_id":1,"body_font_id":1,"auto_convert_quote":1,"all_pages_footer":0,"all_pages_header":0,"show_currency_code":0,"enable_portal_password":0,"send_portal_password":0,"recurring_invoice_number_prefix":"R","enable_client_portal":1,"invoice_fields":null,"devices":null,"logo":null,"logo_width":0,"logo_height":0,"logo_size":0,"invoice_embed_documents":0,"document_email_attachment":0,"enable_client_portal_dashboard":1,"company_id":1,"page_size":"A4","live_preview":1,"realtime_preview":1,"invoice_number_padding":4,"enable_second_tax_rate":1,"auto_bill_on_due_date":0,"start_of_week":0,"enable_buy_now_buttons":0,"include_item_taxes_inline":1,"financial_year_start":null,"enabled_modules":63,"enabled_dashboard_sections":7,"show_accept_invoice_terms":0,"show_accept_quote_terms":0,"require_invoice_signature":0,"require_quote_signature":0,"client_number_prefix":null,"client_number_counter":0,"client_number_pattern":null,"domain_id":1,"payment_terms":15,"reset_counter_frequency_id":null,"payment_type_id":17,"gateway_fee_enabled":0,"reset_counter_date":null,"tax_name1":"Domestic High","tax_rate1":"21.000","tax_name2":"Domestic High","tax_rate2":"21.000","quote_design_id":1,"custom_design2":null,"custom_design3":null,"analytics_key":null,"credit_number_counter":0,"credit_number_prefix":null,"credit_number_pattern":null,"task_rate":"0.0000","inclusive_taxes":1,"convert_products":0,"signature_on_pdf":0,"ubl_email_attachment":0,"auto_archive_invoice":0,"auto_archive_quote":0,"auto_email_invoice":1,"send_item_details":0,"custom_fields":{},"background_image_id":null,"custom_messages":{},"is_custom_domain":0,"allow_approve_expired_quote":0,"custom_fields_options":{},"client_view_js":"","show_product_notes":0,"require_approve_quote":1,"valid_until_days":0,"companyPlan":{"id":1,"plan":null,"plan_term":null,"plan_started":null,"plan_paid":null,"plan_expires":null,"payment_id":null,"trial_started":null,"trial_plan":null,"pending_plan":null,"pending_term":null,"created_at":"2020-08-08 18:20:19","updated_at":"2020-08-08 18:20:19","deleted_at":null,"plan_price":null,"pending_plan_price":null,"num_users":1,"pending_num_users":1,"utm_source":null,"utm_medium":null,"utm_campaign":null,"utm_term":null,"utm_content":null,"discount":0,"discount_expires":null,"promo_expires":null,"bluevine_status":null,"referral_code":null,"app_store_order_id":null},"language":{"id":1,"name":"English","locale":"en"},"currency":{"id":1,"name":"US Dollar","symbol":"$","precision":"2","thousand_separator":",","decimal_separator":".","code":"USD","swap_currency_symbol":false,"exchange_rate":null},"datetime_format":null};
        var chartGroupBy = 'day';
        var realCurrencyId = 1;
        var chartCurrencyId = 1;
		...
		var dateRanges = {
            ...
            "Current Quarter": [moment().quarter(chartQuarter).startOf("quarter"), moment().quarter(chartQuarter).endOf("quarter")],
            "Last Quarter": [moment().subtract(1, "quarter").startOf("quarter"), moment().subtract(1, "quarter").endOf("quarter")],
            "This Year": [moment().date(1).month(0).year(2020), moment()],
            "Last Year": [moment().date(1).month(0).year(2019), moment().date(1).month(0).year(2020).subtract(1, "day")],
        };
		var chartStartDate;
        var chartEndDate;
        ...
        $(function() {
            ...
            function cb(start, end, label) {
				...
				if (isStorageSupported() && label && label != "Custom Range") {
            ...
            $("#currency-btn-group > .btn").click(function(){
                ...
                if(t.attr("data-button") === "totals"){
                    realCurrencyId  = company.currency.id;
            ...
            function loadData() {
                ...
                var url = 'http://invninjv1.local/dashboard_chart_data/' + chartGroupBy + '/' + chartStartDate.format('YYYY-MM-DD') + '/' + chartEndDate.format('YYYY-MM-DD') + '/' + chartCurrencyId + '/' + includeExpenses;
                $.get(url, function(response) {
                    response = JSON.parse(response);
                    loadChart(response.data);

                    var totals = response.totals;
                    $('.revenue-div').text(formatMoney(totals.revenue, realCurrencyId, company.country_id));
                    $('.outstanding-div').text(formatMoney(totals.balance, realCurrencyId, company.country_id));
                    $('.expenses-div').text(formatMoney(totals.expenses, realCurrencyId, company.country_id));
                    $('.average-div').text(formatMoney(totals.average, realCurrencyId, company.country_id));
    ...
    <div class="row" id="dashboard-totals-in-all-currencies-help" style="display: none">
        <div class="col-xs-12">
            <div class="alert alert-warning custom-message">Note: add a <a href="/settings/invoice_settings#invoice_fields" target="_blank">Custom Field</a> named "Exchange Rate" to show the totals using a single base currency.</div>
        </div>
    </div>
    ...
    <div class="col-md-2">
        <ol class="breadcrumb"><li class='active'>Dashboard</li></ol>
            ...
            <div class="col-md-10">
              ...
              <button type="button" class="btn btn-normal active" data-button="day" style="font-weight:normal !important;background-color:white">Day</button>
              <button type="button" class="btn btn-normal" data-button="week" style="font-weight:normal !important;background-color:white">Week</button>
              <button type="button" class="btn btn-normal" data-button="month" style="font-weight:normal !important;background-color:white">Month</button>
            </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div id="signUpDiv" onkeyup="validateSignUp()" onclick="validateSignUp()" onkeydown="checkForEnter(event)">
        <form accept-charset="utf-8" class="form-horizontal signUpForm" autocomplete="off" method="POST" action="/signup/submit">

        
        <div style="display:none">
          <div class="form-group"><label for="path" class="control-label col-lg-4 col-sm-4">path</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="path" type="text" name="path" value="dashboard"></div></div>
          <div class="form-group"><label for="go_pro" class="control-label col-lg-4 col-sm-4">Go Pro</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="go_pro" type="text" name="go_pro"></div></div>
        </div>

        <div class="row signup-form">
            <div class="col-md-12">
                <div class="checkbox"><label for="terms_checkbox" class=""><input type="hidden" name="terms_checkbox" value="0"><input id="terms_checkbox" type="checkbox" name="terms_checkbox" value="1">I agree to the <a href="https://www.invoiceninja.com/self-hosting-terms-service/" target="_blank">Terms of Service</a></label></div>
                    <div class="checkbox"><label for="privacy_checkbox" class=""><input type="hidden" name="privacy_checkbox" value="0"><input id="privacy_checkbox" type="checkbox" name="privacy_checkbox" value="1">I agree to the <a href="https://www.invoiceninja.com/self-hosting-privacy-data-control/" target="_blank">Privacy Policy</a></label></div>
                <br/>
            </div>
            <br/>&nbsp;<br/>
                            <div class="col-md-12">
                ...
                <div class="form-group"><label for="new_first_name" class="control-label col-lg-0 col-sm-0"> </label><div class="col-lg-12 col-sm-12"><input class="form-control" placeholder="First Name" autocomplete="given-name" data-lpignore="true" id="new_first_name" type="text" name="new_first_name"></div></div>
                <div class="form-group"><label for="new_last_name" class="control-label col-lg-0 col-sm-0"> </label><div class="col-lg-12 col-sm-12"><input class="form-control" placeholder="Last Name" autocomplete="family-name" data-lpignore="true" id="new_last_name" type="text" name="new_last_name"></div></div>
                <div class="form-group"><label for="new_email" class="control-label col-lg-0 col-sm-0"> </label><div class="col-lg-12 col-sm-12"><input class="form-control" placeholder="Email" autocomplete="email" data-lpignore="true" id="new_email" type="text" name="new_email"></div></div>
                <div class="form-group"><label for="new_password" class="control-label col-lg-0 col-sm-0"> </label><div class="col-lg-12 col-sm-12"><input class="form-control" placeholder="Password" autocomplete="new-password" data-lpignore="true" id="new_password" type="text" name="new_password"><span class="help-block"><span id="passwordStrength">&nbsp;</span></span></div></div>

                
                
            </div>

            <center><div id="errorTaken" style="display:none">&nbsp;<br/><b>The email address is already registered</b></div></center>

            <div class="col-md-12">
                <div style="padding-top:20px;padding-bottom:10px;">
                                            We require each companyPlan to have a unique email address.<br/>Consider using an alias. ie, email+label@example.com
                                    </div>
            </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/introduction.html#dashboard" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/dashboard?sign_up=true' != settingsURL) {
