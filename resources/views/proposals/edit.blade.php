...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function mergeTemplate(html) {
            ...
            invoice.company = {!! auth()->user()->company->load('country') !!};
            ...
            if (matches) {
                for (var i = 0; i < matches.length; i++) {
                    ...
                    } else if (['invoice_date', 'due_at', 'partial_due_date'].indexOf(field) >= 0) {
                        value = moment.utc(value).format('{{ $company->getMomentDateFormat() }}');
                    }
