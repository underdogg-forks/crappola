...
@section('content')
    ...
    <div class="container mx-auto main-container">
        ...
        <div class="flex flex-wrap" id="main-row">
            <div class="md:w-1/4 pr-4 pl-4" id="contact-details">
                <h3>{{$client->name}}</h3>
            ...
            <div class="md:w-1/4 pr-4 pl-4 amount-col" id="total-invoiced-col">
                <div class="inner">
            ...
            <div class="md:w-1/4 pr-4 pl-4 amount-col" id="paidtodate-col">
                <div class="inner">
            ...
            <div class="md:w-1/4 pr-4 pl-4 amount-col" id="balance-col">
                <div class="inner">
        ...
        <div class="flex flex-wrap" id="account-row">
            <div class="md:w-1/5 pr-4 pl-4 invoices-from">
                {{trans('texts.invoice_from')}}
            </div>
            <div class="md:w-1/3 pr-4 pl-4 logo">
                @if ($account->hasLogo())
            ...
            <div class="md:w-1/4 pr-4 pl-4 address-details">
                @if ($account->address1)
                    {{ $account->address1 }}<br/>
                @endif
                @if ($account->address2)
            ...
            <div class="md:w-1/4 pr-4 pl-4 phone-web-details">
                <div class="inner">
