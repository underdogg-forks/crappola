...
<script type="text/javascript">
    ...
    <div class="container">
        ...
        <form accept-charset="utf-8" class="form-horizontal form-signin" method="POST" action="/login">
        ...
        <hr class="green">
                    ...
                    <div class="alert alert-warning">Successfully completed update - <a href="https://github.com/invoiceninja/invoiceninja/releases" target="_blank">See what&#039;s new in v4.5.19</a></div>
        ...
        <div class="row meta">
                    ...
                    <a href="/recover_password">Recover your password</a>
                </div>
