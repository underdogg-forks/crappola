...
@section('head')
    ...
    <style type="text/css">{!! !empty($company)?$company->clientViewCSS():'' !!}</style>
@stop
...
@section('body')
        ...
        <nav class="navbar navbar-top navbar-inverse">
            <div class="container">
                <div class="navbar-header">
                    ...
                    @if (empty($company) || !$company->hasFeature(FEATURE_WHITE_LABEL))
                ...
                <div id="navbar" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        @if (! empty($company) && $company->enable_client_portal)
                            ...
                            @endif
                            @if ($company->enable_portal_password && request()->contact->password)
                                <li>
                                    {!! link_to('/client/logout?account_key=' . $company->account_key, trans('texts.logout')) !!}
                                </li>
                            @endif
    ...
    @if(Utils::isSelfHost() && !empty($company) && !empty($company->clientViewJS()))
        {!! $company->clientViewJS() !!}
    @endif
