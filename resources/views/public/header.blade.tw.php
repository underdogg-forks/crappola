...
{!! Form::hidden('sign_up', request()->get('sign_up')) !!}
{!! Form::hidden('redirect_to', request()->get('redirect_to')) !!}
{!! Form::close() !!}
...
<div id="header">
    <nav class="relative flex flex-wrap items-center content-between py-2 px-4 navbar-top navbar-inverse">
        <div class="container mx-auto">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#relative flex flex-wrap items-center content-between py-2 px-4" aria-expanded="false" aria-controls="navbar">
                ...
                @if (empty($account) || !$account->hasFeature(FEATURE_WHITE_LABEL))
                    ...
                    <a class="inline-block pt-1 pb-1 mr-4 text-lg whitespace-no-wrap" href="{{ URL::to(NINJA_WEB_URL) }}" target="_blank"><img
                                src="{{ asset('images/invoiceninja-logo.png') }}" style="height:27px"></a>
                @endif
            </div>
            <div id="navbar" class="collapse flex-grow items-center">
