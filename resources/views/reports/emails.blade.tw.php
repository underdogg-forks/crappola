	...
	<div class="flex flex-wrap">
	    <div class="md:w-1/2 pr-4 pl-4">
	        <div class="panel panel-default">
				...
				<div class="panel-body" style="height:280px;overflow-y:auto;">
	                <table class="w-full max-w-full mb-4 bg-transparent table-striped" id="platformsTable">
					</table>
				</div>
	        </div>
	    </div>
	    <div class="md:w-1/2 pr-4 pl-4">
	        <div class="panel panel-default">
				...
				<div class="panel-body" style="height:280px;overflow-y:auto;">
	                <table class="w-full max-w-full mb-4 bg-transparent table-striped" id="emailClientsTable">
					</table>
				</div>
	        </div>
	    </div>
