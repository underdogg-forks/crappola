...
@section('content')
            ...
            <div class="panel-body">
                <div class="flex flex-wrap">
                    <div class="md:w-1/2 pr-4 pl-4">
						...
						<div class="mb-4">
                            <label for="reportrange" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4">
                    ...
                    <div class="md:w-1/2 pr-4 pl-4">
						...
						<div id="statusField" style="display:none" data-bind="visible: showStatus">
							<div class="mb-4">
								<label for="status_ids" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4">{{ trans('texts.status') }}</label>
								<div class="lg:w-2/3 pr-4 pl-4 sm:w-2/3 pr-4 pl-4">
									<select name="status_ids[]" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" style="width: 100%;" id="statuses_{{ ENTITY_INVOICE }}" multiple="true">
	...
	<center class="buttons flex items-center">
		...
		@if (request()->report_type)
			<button id="popover" type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default py-3 px-4 text-xl leading-tight">
			  {{ trans('texts.columns') }}
			  {!! Icon::create('th-list') !!}
			</button>
	...
	<div class="modal opacity-0" id="scheduleModal" tabindex="-1" role="dialog" aria-labelledby="scheduleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer" id="signUpFooter" style="margin-top: 0px">
              ...
              <button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-green-lightest bg-green hover:bg-green-light" onclick="onScheduleClick()">{{ trans('texts.schedule') }} </button>
            </div>
          </div>
        </div>
    </div>
