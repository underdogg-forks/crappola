...
@section('content')
    ...
    <form class="flex items-center" role="form">
        {{ trans('texts.group_by') }} &nbsp;&nbsp;
        <select id="groupBySelect" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" onchange="update()" style="background-color:white !important">
