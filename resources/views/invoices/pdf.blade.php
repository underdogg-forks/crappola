...
<script type="text/javascript">
    ...
    @endif
            ...
            @if ($company->isEnterprise() && $company->background_image_id && $company->background_image)
        window.accountBackground = "{{ Form::image_data($company->background_image->getRawCached(), true) }}";
    @endif
