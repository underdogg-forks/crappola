...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Enter Payment | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/payments/create"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Payments &gt; Enter Payment"
            href="https://invoice-ninja.readthedocs.io/en/latest/payments.html#enter-payment" target="_blank">
...
<script type="text/javascript">
	...
	<form accept-charset="utf-8" class="form-horizontal col-lg-10 col-lg-offset-1 warn-on-exit main-form" onsubmit="return onFormSubmit(event)" autocomplete="off" method="POST">

                
    <span style="display:none">
        <div class="form-group"><label for="public_id" class="control-label col-lg-4 col-sm-4">public id</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="public_id" type="text" name="public_id"></div></div>
	...
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="panel-body">
            			 ...
            			 <div class="form-group client-select required"><label for="client" class="control-label col-lg-4 col-sm-4">Client</label><div class="col-lg-8 col-sm-8"><select required class="form-control" id="client" name="client"><option value=""></option></select></div></div>
			 <div class="form-group invoice-select required"><label for="invoice" class="control-label col-lg-4 col-sm-4">Invoice</label><div class="col-lg-8 col-sm-8"><select required class="form-control" id="invoice" name="invoice"><option value=""></option></select></div></div>
			 <div class="form-group required"><label for="amount" class="control-label col-lg-4 col-sm-4">Amount</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input required class="form-control" id="amount" type="text" name="amount"><span class="input-group-addon"><span data-bind="html: paymentCurrencyCode"></span></span></div></div></div>
            ...
            <div class="form-group"><label for="private_notes" class="control-label col-lg-4 col-sm-4">Private Notes</label><div class="col-lg-8 col-sm-8"><textarea class="form-control" id="private_notes" name="private_notes"></textarea></div></div>
            ...
            <div style="display:none" data-bind="visible: enableExchangeRate">
                ...
                <div class="form-group"><label for="" class="control-label col-lg-4 col-sm-4">Converted Amount</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" data-bind="value: convertedAmount, enable: enableExchangeRate" id="" type="text" name=""><span class="input-group-addon"><span data-bind="html: exchangeCurrencyCode"></span></span></div></div></div>
            </div>


                            <div class="form-group"><label for="email_receipt" class="control-label col-lg-4 col-sm-4">&nbsp;</label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="email_receipt" class=""><input type="hidden" name="email_receipt" value="0"><input onchange="onEmailReceiptChange()" id="email_receipt" type="checkbox" name="email_receipt" value="1">Email payment receipt to the client</label></div></div></div>
    ...
    <div class="modal-dialog" style="min-width:150px">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="paymentRefundModalLabel">Refund Payment</h4>
            </div>
                    ...
                    <div class="panel-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label for="refundAmount" class="col-sm-offset-2 col-sm-2 control-label">Amount</label>
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        <span class="input-group-addon" id="refundCurrencySymbol"></span>
                                        <input type="number" class="form-control" id="refundAmount" name="refund_amount" step="0.01" min="0.01" placeholder="Amount">
                                    </div>
                                    <div class="help-block">Max: <span id="refundMax"></span></div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group">
                                        <div class="checkbox"><label for="refund_email" class=""><input type="hidden" name="refund_email" value="0"><input id="refund_email" type="checkbox" name="refund_email" value="1">Send email to the client</label></div>
                                    </div>
                                </div>
                            </div><br/>

                            <div id="refundLocalWarning" class="text-muted">
                                The refund will be recorded in the app but will NOT be processed by the payment gateway.
                            </div>
            ...
            <div class="modal-footer" style="margin-top: 2px">
                ...
                <button type="button" class="btn btn-primary" id="completeRefundButton">Refund</button>
            </div>
...
$(function() {
    ...
    function onFormSubmit(event) {
        if (! canSubmitPayment) {
            ...
            if (NINJA.parseFloat(amount) <= invoice.balance || confirm("The amount is greater than the invoice balance, a credit will be created with the remaining amount.")) {
    ...
    function submitAjax() {
        $.post('http://invninjv1.local/payments', $('.main-form').serialize(), function(data) {
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/payments.html#enter-payment" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/payments/create' != settingsURL) {
