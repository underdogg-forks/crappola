<div class="modal opacity-0" id="emailModal" tabindex="-1" role="dialog" aria-labelledby="emailModalLabel" aria-hidden="true" style="z-index:10000">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f8f8f8">
            ...
            <div class="panel-body">
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="customize">
                        ...
                        <br/>
                        <div id="templateEditor" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" style="min-height:160px"></div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="history">
                        ...
                        <table class="w-full max-w-full mb-4 bg-transparent table-striped data-table">
                            <tr>
            ...
            <div class="modal-footer" style="margin-top: 2px; padding-right:0px">
                ...
                <button id="sendEmailButton" type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-teal-lightest bg-teal hover:bg-teal-light" onclick="onConfirmEmailClick()">{{ trans('texts.send_email') }}</button>
            </div>
            </div>
        </div>
    </div>
