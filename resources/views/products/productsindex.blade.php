...
<head>
    ...
    <title>Products | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/products"/>
...
<div id="wrapper" class=' toggled-right'>
        ...
        <ul class="sidebar-nav sidebar-nav-dark">
            ...
            <li class="nav-settings ">
                ...
                <a type="button" class="btn btn-default btn-sm pull-right"
                   title="User Guide: Settings &gt; Product Library"
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <form accept-charset="utf-8" class="form-horizontal listForm_product" method="POST" action="/products/bulk">

                <div style="display:none">
                    <div class="form-group"><label for="action_product"
                                                   class="control-label col-lg-4 col-sm-4">Action</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="action_product" type="text"
                                                              name="action"></div>
                    </div>
                    <div class="form-group"><label for="public_id_product" class="control-label col-lg-4 col-sm-4">public
                            id</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="public_id_product" type="text"
                                                              name="public_id"></div>
                    </div>
                ...
                <div class="pull-left">
                    <button type='button' class='btn btn-primary invoice'
                            onclick='submitForm_product(&quot;invoice&quot;)'>Invoice <span
                    ...
                    <div class='btn-group'>
                        ...
                        <ul class='dropdown-menu' role='menu' aria-labelledby='dLabel'>
                            <li><a href='javascript:submitForm_product("archive")'>Archive Product</a></li>
                            <li><a href='javascript:submitForm_product("delete")'>Delete Product</a></li>
                        </ul>
                    </div>

                    &nbsp;
                    <span id="statusWrapper_product" style="display:none">
                        <select class="form-control" style="width: 220px" id="statuses_product" multiple="true">
                    ...
                    &nbsp;
                    <span class="well well-sm" id="sum_column_product"
                          style="display:none;padding-left:12px;padding-right:12px;"></span>
                </div>

                <div id="top_right_buttons" class="pull-right">
                    <input id="tableFilter_product" type="text"
                    ...
                    <a class='btn btn-primary' href='http://invninjv1.local/products/create'>New Product <span
                                class='glyphicon glyphicon-plus-sign'></span></a>

                </div>


                <table class="table table-striped data-table Cr5GBx2B">
                    <colgroup>
                        <col class="con0"/>
                        <col class="con1"/>
                        <col class="con2"/>
                ...
                <script type="text/javascript">
                    ...
                    function refreshDatatable_products() {
                        window['dataTable_products'].api().ajax.reload();
                    }

                    function load_Cr5GBx2B() {
                        window['dataTable_products'] = jQuery('.Cr5GBx2B').dataTable({
                            "stateSave": true,
                            "stateDuration": 0,
                            ...
                            "sPaginationType": "bootstrap",
                            "bProcessing": false,
                            "sAjaxSource": "http:\/\/invninjv1.local\/api\/products",
                            "bServerSide": true,
                            "aaSorting": [[4, "desc"]],
                            "fnDrawCallback": function (oSettings) {
                                if (window.onDatatableReady_products) {
                                    window.onDatatableReady_products();
            ...
            <style type="text/css">
                ...
                .listForm_product table.dataTable td:nth-child(4) {
                    text-align: right;
                }
            ...
            <script type="text/javascript">
                ...
                function submitForm_product(action, id) {
                    ...
                    if (id) {
                        $('#public_id_product').val(id);
                    }

                    if (action == 'delete' || action == 'emailInvoice') {
                        sweetConfirm(function () {
                            $('#action_product').val(action);
                            $('form.listForm_product').submit();
                        });
                    } else {
                        $('#action_product').val(action);
                        $('form.listForm_product').submit();
                ...
                $(function () {
                    ...
                    function filterTable_product(val) {
                        if (val == tableFilter) {
                            return;
                        }
                        tableFilter = val;
                        var oTable0 = $('.listForm_product .data-table').dataTable();
                        oTable0.fnFilter(val);
                    }

                    $('#tableFilter_product').on('keyup', function () {
                        if (searchTimeout) {
                            window.clearTimeout(searchTimeout);
                        }
                        searchTimeout = setTimeout(function () {
                            filterTable_product($('#tableFilter_product').val());
                        }, 500);
                    })

                    if ($('#tableFilter_product').val()) {
                        filterTable_product($('#tableFilter_product').val());
                    }

                    $('.listForm_product .head0').click(function (event) {
                        if (event.target.type !== 'checkbox') {
                            $('.listForm_product .head0 input[type=checkbox]').click();
                        }
                    });

                    // Enable/disable bulk action buttons
                    window.onDatatableReady_products = function () {
                        $(':checkbox').click(function () {
                            setBulkActionsEnabled_product();
                            changeSumLabel();
                        });

                        $('.listForm_product tbody tr').unbind('click').click(function (event) {
                    ...
                    $('.listForm_product .archive, .invoice').prop('disabled', true);
                    $('.listForm_product .archive:not(.dropdown-toggle)').click(function () {
                        submitForm_product('archive');
                    });

                    $('.listForm_product .selectAll').click(function () {
                        $(this).closest('table').find(':checkbox:not(:disabled)').prop('checked', this.checked);
                    });

                    function setBulkActionsEnabled_product() {
                        var buttonLabel = "Archive";
                        var count = $('.listForm_product tbody :checkbox:checked').length;
                        $('.listForm_product button.archive, .listForm_product button.invoice').prop('disabled', !count);
                        if (count) {
                            buttonLabel += ' (' + count + ')';
                        }
                        $('.listForm_product button.archive').not('.dropdown-toggle').text(buttonLabel);
                    }
                    ...
                    function changeSumLabel() {
                        var dTable = $('.listForm_product .data-table').DataTable();
                        sumColumnNodes = dTable.column(3).data().toArray();
                        var sum = 0;
                        ...
                        if (sum) {
                            $('#sum_column_product').show().text("Total: " + sum)
                        } else {
                            $('#sum_column_product').hide();
                        }

                    }

                    // Setup state/status filter
                    $('#statuses_product').select2({
                        placeholder: "Status",
                        //allowClear: true,
                        ...
                        .trigger('change')
                        .on('change', function () {
                            var filter = $('#statuses_product').val();
                            if (filter) {
                                filter = filter.join(',');
                            } else {
                                filter = '';
                            }
                            var url = 'http://invninjv1.local/set_entity_filter/product' + '/' + filter;
                            $.get(url, function (data) {
                                refreshDatatable_products();
                            })
                        }).maximizeSelect2Height();

                    $('#statusWrapper_product').show();
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary"
                       href="https://invoice-ninja.readthedocs.io/en/latest/settings.html#product-library"
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('http://invninjv1.local/products' != settingsURL) {
