...
<div style="display:none">
	<div class="form-group"><label for="action_product" class="control-label col-lg-4 col-sm-4">Action</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="action_product" type="text" name="action"></div></div>
    <div class="form-group"><label for="public_id_product" class="control-label col-lg-4 col-sm-4">public id</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="public_id_product" type="text" name="public_id"></div></div>
...
<div class="pull-left">
						<button type='button' class='btn btn-primary invoice' onclick='submitForm_product(&quot;invoice&quot;)'>Invoice <span class='glyphicon glyphicon-check'></span></button>
			
	<div class='btn-group'><button class='btn btn-default archive' type='button'>Archive</button><button class='btn btn-default dropdown-toggle archive' data-toggle='dropdown' type='button'><span class='caret'></span></button><ul class='dropdown-menu' role='menu' aria-labelledby='dLabel'><li><a href='javascript:submitForm_product("archive")'>Archive Product</a></li><li><a href='javascript:submitForm_product("delete")'>Delete Product</a></li></ul></div>
	...
	&nbsp;
	<span class="well well-sm" id="sum_column_product" style="display:none;padding-left:12px;padding-right:12px;"></span>
</div>

<div id="top_right_buttons" class="pull-right">
	<input id="tableFilter_product" type="text" style="width:180px;margin-right:17px;background-color: white !important"
        class="form-control pull-left" placeholder="Filter" value=""/>

                
	
	    	<a class='btn btn-primary' href='http://invninjv1.local/products/create'>New Product <span class='glyphicon glyphicon-plus-sign'></span></a>
