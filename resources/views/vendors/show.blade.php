        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    @if ($vendor->company->customLabel('vendor1') && $vendor->custom_value1)
                        {{ $vendor->company->present()->customLabel('vendor1') . ': ' }} {!! nl2br(e($vendor->custom_value1)) !!}
                        <br/>
                    @endif
                    @if ($vendor->company->customLabel('vendor2') && $vendor->custom_value2)
                        {{ $vendor->company->present()->customLabel('vendor2') . ': ' }} {!! nl2br(e($vendor->custom_value2)) !!}
                        <br/>
                    @endif
                            ...
                            <tr>
                                ...
                                <td style="text-align: right">
                                    @foreach ($vendor->getUnpaidExpenses() as $currency)
                                        <p>{{ Utils::formatMoney($currency->amount, $currency->invoice_currency_id) }}</p>
                                    @endforeach
                                </td>
                            </tr>
                        </table>
