...
<nav class="relative flex flex-wrap items-center content-between py-2 px-4 navbar-default navbar-fixed-top" role="navigation" style="height:60px;">
    ...
    <div class="collapse flex-grow items-center" id="navbar-collapse-1">
      <div class="navbar-form navbar-right">
        ...
        <div class="relative inline-flex align-middle user-dropdown">
          <button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default py-1 px-2 text-sm leading-tight  inline-block w-0 h-0 ml-1 align border-b-0 border-t-1 border-r-1 border-l-1" data-toggle="relative">
          ...
          <ul class=" absolute pin-l z-50 float-left hidden list-reset	 py-2 mt-1 text-base bg-white border border-grey-light rounded user-accounts">
      ...
      {!! Former::open('/handle_command')->id('search-form')->addClass('navbar-form navbar-right')->role('search') !!}
        <div class="mb-4 has-feedback">
          <input type="text" name="command" id="search" style="width: 280px;padding-top:0px;padding-bottom:0px;margin-right:12px;"
            class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" placeholder="{{ trans('texts.search') . ': ' . trans('texts.search_hotkey')}}"/>
      ...
      <ul class="flex flex-wrap list-reset pl-0 mb-0 flex flex-wrap list-reset pl-0 mb-0 navbar-right">
        <li class="relative">
           @section('self-updater')
            <a href="{{ URL::to('self-update') }}" class=" inline-block w-0 h-0 ml-1 align border-b-0 border-t-1 border-r-1 border-l-1">
      ...
      <ul class="flex flex-wrap list-reset pl-0 mb-0 flex flex-wrap list-reset pl-0 mb-0 hide-non-phone" style="font-weight: bold">
        @foreach ([
            'dashboard' => false,
            'clients' => false,
            'products' => false,
    ...
    <div id="page-content-wrapper">
        <div class="container mx-auto mx-auto">
          ...
          @elseif (env('WARNING_MESSAGE'))
            <div class="relative px-3 py-3 mb-4 border rounded text-yellow-darker border-yellow-dark bg-yellow-lighter">{!! env('WARNING_MESSAGE') !!}</div>
          @endif

          @if (Session::has('message'))
            <div class="relative px-3 py-3 mb-4 border rounded text-teal-darker border-teal-dark bg-teal-lighter alert-hide" style="z-index:9999">
              {{ Session::get('message') }}
            </div>
