...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>New Category | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/expense_categories/create"/>
...
<script type="text/javascript">
	...
	<form accept-charset="utf-8" class="form-horizontal col-lg-10 col-lg-offset-1 warn-on-exit" method="POST" action="/expense_categories">
	...
	<center class="buttons">
        <a class='btn btn-default btn-lg' href='http://invninjv1.local/expense_categories'>Cancel <span class='glyphicon glyphicon-remove-circle'></span></a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/expense_categories/create' != settingsURL) {
