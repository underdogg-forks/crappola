...
<div class="flex flex-wrap">
    <div class="md:w-1/5 pr-4 pl-4">
        <ol class="flex flex-wrap list-reset pt-3 pb-3 py-4 px-4 mb-4 bg-grey-light rounded"><li class='active'>{{ trans('texts.dashboard') }}</li></ol>
    </div>
    @if (count($tasks))
        <div class="md:w-1/5 pr-4 pl-4" style="padding-top:6px">
    ...
    @endif
        ...
        <div class="pull-right">
            @if (count($currencies) > 1)
            <div id="currency-btn-group" class="relative inline-flex align-middle" role="group" style="border: 1px solid #ccc;">
              @foreach ($currencies as $key => $val)
                <button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-normal {{ array_values($currencies)[0] == $val ? 'active' : '' }}"
                    data-button="{{ $key }}" style="font-weight:normal !important;background-color:white">{{ $val }}</button>
              @endforeach
            </div>
            @endif
            <div id="group-btn-group" class="relative inline-flex align-middle" role="group" style="border: 1px solid #ccc; margin-left:18px">
              <button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-normal active" data-button="day" style="font-weight:normal !important;background-color:white">{{ trans('texts.day') }}</button>
              <button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-normal" data-button="week" style="font-weight:normal !important;background-color:white">{{ trans('texts.week') }}</button>
              <button type="button" class="inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-normal" data-button="month" style="font-weight:normal !important;background-color:white">{{ trans('texts.month') }}</button>
            </div>
...
<div class="flex flex-wrap">
    <div class="md:w-1/2 pr-4 pl-4">
        <div class="panel panel-default dashboard" style="height:320px">
            ...
            <ul class="panel-body flex flex-col pl-0 mb-0 border rounded border-grey-light" style="height:276px;overflow-y:auto;">
                @foreach ($activities as $activity)
                <li class="relative block py-3 px-6 -mb-px border border-r-0 border-l-0 border-grey-light no-underline">
