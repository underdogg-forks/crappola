...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>Enter Expense | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/expenses/create"/>
...
<div id="wrapper" class=' toggled-right'>
    ...
    <a href="/reports"
        ...
        Reports
            ...
            <a type="button" class="btn btn-default btn-sm pull-right" title="User Guide: Expenses &gt; Create Expense"
            href="https://invoice-ninja.readthedocs.io/en/latest/expenses.html#create-expense" target="_blank">
...
<script type="text/javascript">
	...
	<form accept-charset="utf-8" class="form-horizontal warn-on-exit main-form" onsubmit="return onFormSubmit(event)" autocomplete="off" method="POST" action="/expenses">
    <div style="display:none">
        ...
        <div class="form-group"><label for="data" class="control-label col-lg-4 col-sm-4">Data</label><div class="col-lg-8 col-sm-8"><input class="form-control" data-bind="value: ko.mapping.toJSON(model)" id="data" type="text" name="data"></div></div>
    </div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        setTaxSelect(2);
                                            ...
                                            <div class="form-group"><label for="should_be_invoiced" class="control-label col-lg-4 col-sm-4"> </label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="should_be_invoiced" class=""><input type="hidden" name="should_be_invoiced" value="0"><input data-bind="checked: should_be_invoiced()" id="should_be_invoiced" type="checkbox" name="should_be_invoiced" value="1">Mark billable</label></div></div></div>
                    
                                            
                                                            <div class="form-group"><label for="mark_paid" class="control-label col-lg-4 col-sm-4"> </label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="mark_paid" class=""><input type="hidden" name="mark_paid" value="0"><input data-bind="checked: mark_paid" id="mark_paid" type="checkbox" name="mark_paid" value="1">Mark paid</label></div></div></div>
                            
                            <div style="display:none" data-bind="visible: mark_paid">
                                <div class="form-group payment-type-select"><label for="payment_type_id" class="control-label col-lg-4 col-sm-4">Payment Type</label><div class="col-lg-8 col-sm-8"><select class="form-control" id="payment_type_id" name="payment_type_id"><option value=""></option><option value="5">ACH</option><option value="28">Alipay</option><option value="8">American Express</option><option value="1">Apply Credit</option><option value="2">Bank Transfer</option><option value="32">Bitcoin</option><option value="17">Carte Blanche</option><option value="3">Cash</option><option value="16">Check</option><option value="13">Credit Card Other</option><option value="4">Debit</option><option value="10">Diners Card</option><option value="9">Discover Card</option><option value="11">EuroCard</option><option value="31">GoCardless</option><option value="15">Google Wallet</option><option value="19">JCB</option><option value="20">Laser</option><option value="21">Maestro</option><option value="7">MasterCard</option><option value="27">Money Order</option><option value="12">Nova</option><option value="14">PayPal</option><option value="30">SEPA Direct Debit</option><option value="29">Sofort</option><option value="22">Solo</option><option value="25">Swish</option><option value="23">Switch</option><option value="18">UnionPay</option><option value="26">Venmo</option><option value="6">Visa Card</option><option value="33">Zelle</option><option value="24">iZettle</option></select></div></div>

                                <div class="form-group payment_date"><label for="payment_date" class="control-label col-lg-4 col-sm-4">Payment Date</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" data-date-format="M d, yyyy" id="payment_date" type="text" name="payment_date"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span></div></div></div>

                                <div class="form-group"><label for="transaction_reference" class="control-label col-lg-4 col-sm-4">Transaction Reference</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="transaction_reference" type="text" name="transaction_reference"></div></div>
                            </div>
                        
                                                    <div class="form-group"><label for="convert_currency" class="control-label col-lg-4 col-sm-4"> </label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="convert_currency" class=""><input type="hidden" name="convert_currency" value="0"><input data-bind="checked: convert_currency" id="convert_currency" type="checkbox" name="convert_currency" value="1">Convert currency</label></div></div></div>
                        

                        <div style="display:none" data-bind="visible: enableExchangeRate">
                            <br/>
                            <span style="display:none" data-bind="visible: !client_id()">
                                <div class="form-group"><label for="invoice_currency_id" class="control-label col-lg-4 col-sm-4">Invoice Currency</label><div class="col-lg-8 col-sm-8"><select class="form-control" data-placeholder="US Dollar" data-bind="combobox: invoice_currency_id, disable: true" id="invoice_currency_id" name="invoice_currency_id"><option value=""></option><option value="94">Albanian Lek</option><option value="90">Algerian Dinar</option><option value="82">Angolan Kwanza</option><option value="23">Argentine Peso</option><option value="97">Armenian Dram</option><option value="40">Aruban Florin</option><option value="12">Australian Dollar</option><option value="98">Azerbaijan Manat</option><option value="77">Bahraini Dinar</option><option value="24">Bangladeshi Taka</option><option value="71">Barbadian Dollar</option><option value="100">Belarusian Ruble</option><option value="93">Bolivian Boliviano</option><option value="99">Bosnia and Herzegovina Convertible Mark</option><option value="68">Botswana Pula</option><option value="20">Brazilian Real</option><option value="2">British Pound</option><option value="72">Brunei Dollar</option><option value="39">Bulgarian Lev</option><option value="86">CFP Franc</option><option value="9">Canadian Dollar</option><option value="88">Cape Verdean Escudo</option><option value="62">Chilean Peso</option><option value="32">Chinese Renminbi</option><option value="30">Colombian Peso</option><option value="47">Costa Rican Colón</option><option value="43">Croatian Kuna</option><option value="51">Czech Koruna</option><option value="5">Danish Krone</option><option value="61">Dominican Peso</option><option value="37">East Caribbean Dollar</option><option value="29">Egyptian Pound</option><option value="3">Euro</option><option value="92">Fijian Dollar</option><option value="73">Georgian Lari</option><option value="38">Ghanaian Cedi</option><option value="101">Gibraltar Pound</option><option value="104">Gibraltar Pound</option><option value="18">Guatemalan Quetzal</option><option value="83">Haitian Gourde</option><option value="75">Honduran Lempira</option><option value="26">Hong Kong Dollar</option><option value="69">Hungarian Forint</option><option value="63">Icelandic Króna</option><option value="11">Indian Rupee</option><option value="27">Indonesian Rupiah</option><option value="6">Israeli Shekel</option><option value="81">Jamaican Dollar</option><option value="45">Japanese Yen</option><option value="65">Jordanian Dinar</option><option value="103">Kazakhstani Tenge</option><option value="8">Kenyan Shilling</option><option value="89">Kuwaiti Dinar</option><option value="96">Lebanese Pound</option><option value="59">Macanese Pataca</option><option value="91">Macedonian Denar</option><option value="19">Malaysian Ringgit</option><option value="46">Maldivian Rufiyaa</option><option value="87">Mauritian Rupee</option><option value="28">Mexican Peso</option><option value="102">Moldovan Leu</option><option value="80">Moroccan Dirham</option><option value="56">Mozambican Metical</option><option value="66">Myanmar Kyat</option><option value="53">Namibian Dollar</option><option value="85">Nepalese Rupee</option><option value="35">Netherlands Antillean Guilder</option><option value="15">New Zealand Dollar</option><option value="22">Nigerian Naira</option><option value="14">Norske Kroner</option><option value="57">Omani Rial</option><option value="48">Pakistani Rupee</option><option value="64">Papua New Guinean Kina</option><option value="67">Peruvian Sol</option><option value="10">Philippine Peso</option><option value="49">Polish Zloty</option><option value="74">Qatari Riyal</option><option value="42">Romanian New Leu</option><option value="55">Russian Ruble</option><option value="33">Rwandan Franc</option><option value="44">Saudi Riyal</option><option value="95">Serbian Dinar</option><option value="13">Singapore Dollar</option><option value="4">South African Rand</option><option value="79">South Korean Won</option><option value="50">Sri Lankan Rupee</option><option value="76">Surinamese Dollar</option><option value="7">Swedish Krona</option><option value="17">Swiss Franc</option><option value="60">Taiwan New Dollar</option><option value="34">Tanzanian Shilling</option><option value="21">Thai Baht</option><option value="36">Trinidad and Tobago Dollar</option><option value="54">Tunisian Dinar</option><option value="41">Turkish Lira</option><option value="1">US Dollar</option><option value="70">Ugandan Shilling</option><option value="58">Ukrainian Hryvnia</option><option value="25">United Arab Emirates Dirham</option><option value="52">Uruguayan Peso</option><option value="78">Venezuelan Bolivars</option><option value="16">Vietnamese Dong</option><option value="31">West African Franc</option><option value="84">Zambian Kwacha</option></select></div></div>
                            </span>
                            <span style="display:none;" data-bind="visible: client_id">
                                <div class="form-group"><label for="" class="control-label col-lg-4 col-sm-4">Invoice Currency</label><div class="col-lg-8 col-sm-8"><div class="form-control-static" style="min-height:46px" id=""><span data-bind="html: invoiceCurrencyName"></span></div></div></div>
                            </span>

                            <div class="form-group"><label for="exchange_rate" class="control-label col-lg-4 col-sm-4">Exchange Rate</label><div class="col-lg-8 col-sm-8"><input class="form-control" data-bind="value: exchange_rate, enable: enableExchangeRate, valueUpdate: 'afterkeydown'" id="exchange_rate" type="text" name="exchange_rate"></div></div>

                            <div class="form-group converted-amount"><label for="invoice_amount" class="control-label col-lg-4 col-sm-4">Invoice Amount</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" data-bind="value: convertedAmount, enable: enableExchangeRate" id="invoice_amount" type="text" name="invoice_amount"><span class="input-group-addon"><span data-bind="html: invoiceCurrencyCode"></span></span></div></div></div>
                        </div>

                                                    <div class="form-group"><label for="invoice_documents" class="control-label col-lg-4 col-sm-4"> </label><div class="col-lg-8 col-sm-8"><div class="checkbox"><label for="invoice_documents" class=""><input type="hidden" name="invoice_documents" value="0"><input onchange="onInvoiceDocumentsChange()" data-bind="checked: invoice_documents" id="invoice_documents" type="checkbox" name="invoice_documents" value="1">Add documents to invoice</label></div></div></div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group"><label for="public_notes" class="control-label col-lg-4 col-sm-4">Public Notes</label><div class="col-lg-8 col-sm-8"><textarea class="form-control" rows="6" id="public_notes" name="public_notes"></textarea></div></div>
    ...
    <script type="text/javascript">
        ...
        function onFormSubmit(event) {
            if (window.countUploadingDocuments > 0) {
                swal("Please wait for the document upload to complete.");
                return false;
            }
        ...
        $(function() {
            ...
            var $vendorSelect = $('select#vendor_id');
                            $vendorSelect.append(new Option("Create vendor: $name", '-1'));
...
$vendorSelect.combobox({
    highlighter: function (item) {
        if (item.indexOf("Create vendor") == 0) {
            vendorName = this.query;
            return "Create vendor: " + this.query;
        } else {
    ...
    template: '<div class="combobox-container"> <input type="hidden" /> <div class="input-group"> <input type="text" id="vendor_name" name="vendor_name" autocomplete="off" /> <span class="input-group-addon dropdown-toggle" data-dropdown="dropdown"> <span class="caret" /> <i class="fa fa-times"></i> </span> </div> </div> ',
    ...
    if (vendorId == '-1') {
        $('#vendor_name').val(vendorName);
            ...
            var $expense_categorySelect = $('select#expense_category_id');
                            $expense_categorySelect.append(new Option("Create category: $name", '-1'));
            ...
            var expense_categoryName = '';

$expense_categorySelect.combobox({
    highlighter: function (item) {
        if (item.indexOf("Create category") == 0) {
            expense_categoryName = this.query;
            return "Create category: " + this.query;
        } else {
            var query = this.query.replace(/[\-\[\]{}()*+?.,\\\^$|#\s]/g, '\\$&');
            item = _.escape(item);
            return item.replace(new RegExp('(' + query + ')', 'ig'), function ($1, match) {
    ...
    template: '<div class="combobox-container"> <input type="hidden" /> <div class="input-group"> <input type="text" id="expense_category_name" name="expense_category_name" autocomplete="off" /> <span class="input-group-addon dropdown-toggle" data-dropdown="dropdown"> <span class="caret" /> <i class="fa fa-times"></i> </span> </div> </div> ',
    matcher: function (item) {
        // if the user has entered a value show the 'Create ...' option
        if (item.indexOf("Create category") == 0) {
            return this.query.length;
    ...
    var expense_categoryId = $('input[name=expense_category_id]').val();
    if (expense_categoryId == '-1') {
        $('#expense_category_name').val(expense_categoryName);
    }
});
            if (categoryId) {
...
function handleDocumentError(file) {
    ...
    swal("An error occurred, please refresh the page and try again.");
        ...
        var ViewModel = function(data) {
            ...
            self.account_currency_id = ko.observable(1);
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest/expenses.html#create-expense" target="_blank">User Guide</a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/expenses/create' != settingsURL) {
