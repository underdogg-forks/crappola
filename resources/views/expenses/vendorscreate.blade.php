...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>New Vendor | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/vendors/create"/>
...
<div class="row">
	...
	<form accept-charset="utf-8" class="form-horizontal col-md-12 warn-on-exit" autocomplete="off" method="POST" action="/vendors">
...
<div style="display: none;">
          ...
          <div class="panel-heading">
			...
			<div data-bind='template: { foreach: vendor_contacts,
				...
				<input data-bind="value: public_id, valueUpdate: 'afterkeydown',
                        attr: {name: 'vendor_contacts[' + $index() + '][public_id]'}" type="hidden" name="public_id" value="">
	...
	model.removeContact = function() {
    	...
    	<a class='btn btn-default btn-lg' href='http://invninjv1.local/vendors'>Cancel <span class='glyphicon glyphicon-remove-circle'></span></a>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/vendors/create' != settingsURL) {
