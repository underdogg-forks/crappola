...
<div id="wrapper" class=' toggled-right'>
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <form accept-charset="utf-8" class="form-horizontal listForm_project" method="POST" action="/projects/bulk">
                ...
                <div style="display:none">
                    <div class="form-group"><label for="action_project"
                                                   class="control-label col-lg-4 col-sm-4">Action</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="action_project" type="text"
                                                              name="action"></div>
                    </div>
                    <div class="form-group"><label for="public_id_project" class="control-label col-lg-4 col-sm-4">public
                            id</label>
                        <div class="col-lg-8 col-sm-8"><input class="form-control" id="public_id_project" type="text"
                                                              name="public_id"></div>
                    </div>
                ...
                <div class="pull-left">
                    <button type='button' class='btn btn-primary invoice'
                            onclick='submitForm_project(&quot;invoice&quot;)'>Invoice <span
                    ...
                    <div class='btn-group'>
                        ...
                        <ul class='dropdown-menu' role='menu' aria-labelledby='dLabel'>
                            <li><a href='javascript:submitForm_project("archive")'>Archive Project</a></li>
                            <li><a href='javascript:submitForm_project("delete")'>Delete Project</a></li>
                        </ul>
                    </div>
		...
		<select class="form-control" style="width: 220px" id="statuses_project" multiple="true">
                    ...
                    &nbsp;
                    <span class="well well-sm" id="sum_column_project"
                          style="display:none;padding-left:12px;padding-right:12px;"></span>
                </div>

                <div id="top_right_buttons" class="pull-right">
                    <input id="tableFilter_project" type="text"
                    ...
                    <a class='btn btn-primary' href='http://invninjv1.local/projects/create'>New Project <span
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="https://www.invoiceninja.com/knowledge-base/" target="_blank">Knowledge
                        Base</a>
                    <a class="btn btn-primary" href="https://invoice-ninja.readthedocs.io/en/latest" target="_blank">User
                        Guide</a>
