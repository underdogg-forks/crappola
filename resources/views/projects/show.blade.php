@php use App\Ninja\Datatables\ProjectTaskDatatable; @endphp
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-md-3">
                    ...
                    @if ($project->due_date)
                        {{ trans('texts.due_at') . ': ' . Utils::fromSqlDate($project->due_date) }}<br/>
                    @endif
                    ...
                    @if ($company->customLabel('project1') && $project->custom_value1)
                        {{ $company->present()->customLabel('project1') . ': ' }} {!! nl2br(e($project->custom_value1)) !!}
                        <br/>
                    @endif
                    @if ($company->customLabel('project2') && $project->custom_value2)
                        {{ $company->present()->customLabel('project2') . ': ' }} {!! nl2br(e($project->custom_value2)) !!}
                        <br/>
                    @endif
