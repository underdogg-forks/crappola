...
<head>
    ...
    <!-- Version: 4.5.19 -->
            ...
            <title>New Project | Invoice Ninja</title>
    ...
    <link rel="canonical" href="https://app.invoiceninja.com/projects/create"/>
...
<script type="text/javascript">
	...
	<form accept-charset="utf-8" class="form-horizontal col-lg-10 col-lg-offset-1 warn-on-exit main-form" autocomplete="off" method="POST" action="/projects">
	...
	<div class="row">
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div class="panel-body">
				...
				<div class="form-group due_date"><label for="due_date" class="control-label col-lg-4 col-sm-4">Due Date</label><div class="col-lg-8 col-sm-8"><div class="input-group"><input class="form-control" data-date-format="M d, yyyy" id="due_date" type="text" name="due_date"><span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span></div></div></div>

				<div class="form-group"><label for="budgeted_hours" class="control-label col-lg-4 col-sm-4">Budgeted Hours</label><div class="col-lg-8 col-sm-8"><input class="form-control" id="budgeted_hours" type="text" name="budgeted_hours"></div></div>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        if ('http://invninjv1.local/projects/create' != settingsURL) {
