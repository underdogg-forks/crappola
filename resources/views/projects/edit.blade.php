            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    {!! Former::text('due_at')
                                ...
                                ->addGroupClass('due_at')
                                ->append('<i class="glyphicon glyphicon-calendar"></i>') !!}

                    {!! Former::text('budgeted_hours') !!}

                    {!! Former::text('task_rate')
                            ->placeholder($project && $project->client->task_rate ? $project->client->present()->taskRate : $company->present()->taskRate)
                             ->help('task_rate_help') !!}
        ...
        $(function () {
            ...
            $clientSelect.combobox({highlighter: comboboxHighlighter}).change(function () {
                ...
                if (client && parseFloat(client.task_rate)) {
                    ...
                    var rate = {{ $company->present()->taskRate ?: 0 }};
                }
