...
@if (Auth::user()->company->hasFeature(FEATURE_WHITE_LABEL))
    ...
    @if (! Utils::isNinja() && $companyPlan->hasActivePlan() && $companyPlan->daysUntilPlanExpires() <= 10 && $companyPlan->daysUntilPlanExpires() > 0)
        <br/><b>{!! trans('texts.license_expiring', [
        'count' => $companyPlan->daysUntilPlanExpires(),
