...
<div id="upgrade-modal" class="container" style="">
    ...
    <div class="row">
        <div class="col-md-12 text-center">
            ...
            @if (Auth::user()->company->companyPlan->hasActivePromo())
                <h4>{{ Auth::user()->company->companyPlan->present()->promoMessage }}</h4><br/>
            @endif
        </div>
...
<script type="text/javascript">
    ...
    function updateUpgradePrices() {
        ...
        @if (Auth::user()->company->companyPlan->hasActivePromo())
            proPrice = proPrice - (proPrice * {{ Auth::user()->company->companyPlan->discount }});
        enterprisePrice = enterprisePrice - (enterprisePrice * {{ Auth::user()->company->companyPlan->discount }});
        @endif
        if (proPrice % 1) {
