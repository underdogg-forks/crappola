...
<head>
    ...
    <title>Dashboard | Invoice Ninja</title>
    <meta name="description"
          content="Invoice Ninja is a free, open-source solution for invoicing and billing customers. With Invoice Ninja, you can easily build and send beautiful invoices from any device that has access to the web. Your clients can print your invoices, download them as pdf files, and even pay you online from within the system."/>
    ...
    <meta name="csrf-token" content="T44A86pl7r3nY4v1nUO7grSKH8OzN0IXPzqnQurx">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <link rel="canonical" href="https://app.invoiceninja.com/dashboard"/>
    ...
    <script type="text/javascript">
        ...
        function openTimeTracker() {
            ...
            window.open("http://invninjv1.local/time_tracker", "time-tracker", "width=" + width + ",height=" + height + ",scrollbars=no,toolbar=no,screenx=" + left + ",screeny=" + top + ",location=no,titlebar=no,directories=no,status=no,menubar=no");
        }
    ...
    <script src="http://invninjv1.local/js/Chart.min.js" type="text/javascript"></script>
    <script src="http://invninjv1.local/js/daterangepicker.min.js" type="text/javascript"></script>
    <link href="http://invninjv1.local/css/daterangepicker.css" rel="stylesheet" type="text/css"/>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="height:60px;">
    ...
    <div class="navbar-header">
        ...
        <a href="#" id="left-menu-toggle" class="menu-toggle" title="Toggle Navigation">
            <div class="navbar-brand">
                ...
                <img src="http://invninjv1.local/images/invoiceninja-logo.png" width="193" height="25"
                     style="float:left"/>
            </div>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-1">
            ...
            <div class="btn-group user-dropdown">
                ...
                <ul class="dropdown-menu user-accounts">
                    <li style="margin-top: 4px; margin-bottom: 4px; min-width: 220px; cursor: pointer">
                        <a href="http://invninjv1.local/settings/user_details">
                            ...
                            <b>
                                ...
                                <div class="user" style="padding-right:90px">John Doe</div>
        ...
        <form accept-charset="utf-8" class="form-horizontal navbar-form navbar-right" id="search-form" role="search"
              method="POST" action="http://invninjv1.local/handle_command">
            ...
            <input type="hidden" name="_token" value="T44A86pl7r3nY4v1nUO7grSKH8OzN0IXPzqnQurx"></form>


        <ul class="nav navbar-nav hide-non-phone" style="font-weight: bold">
            <li class="active"><a href="http://invninjv1.local/dashboard">Dashboard</a></li>


            <li><a href="http://invninjv1.local/settings">Settings</a></li>
        </ul>
    </div><!-- /.navbar-collapse -->
...
<div id="wrapper" class=' toggled-right'>
    ...
    <div id="left-sidebar-wrapper" class="hide-phone">
        <ul class="sidebar-nav sidebar-nav-light">
            <li class="nav-dashboard active">
                ...
                <a href="http://invninjv1.local/dashboard"
            ...
            <li class="nav-clients ">
                ...
                <a href="http://invninjv1.local/clients"
                   style="padding-top:6px; padding-bottom:6px"
                   class="nav-link ">
            ...
            <li class="nav-products ">
                ...
                <a href="http://invninjv1.local/products"
                   style="padding-top:6px; padding-bottom:6px"
                   class="nav-link ">
            ...
            <li class="nav-invoices ">
                ...
                <a href="http://invninjv1.local/invoices"
                   style="padding-top:6px; padding-bottom:6px"
                   class="nav-link ">
            ...
            <li class="nav-payments ">
                ...
                <a href="http://invninjv1.local/payments"
                   style="padding-top:6px; padding-bottom:6px"
                   class="nav-link ">
            ...
            <li class="nav-tickets ">
                ...
                <a href="http://invninjv1.local/tickets"
                   style="padding-top:6px; padding-bottom:6px"
                   class="nav-link ">
            ...
            <li class="nav-settings ">
                ...
                <a type="button" class="btn btn-default btn-sm pull-right"
                   title="User Guide: Introduction &gt; Dashboard"
                   href="https://invoice-ninja.readthedocs.io/en/latest/introduction.html#dashboard" target="_blank">
                    <i class="fa fa-info-circle" style="width:20px"></i>
                </a>

                <a href="http://invninjv1.local/settings"
                   style="padding-top:6px; padding-bottom:6px"
                   class="nav-link ">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row" id="dashboard-totals-in-all-currencies-help" style="display: none">
                <div class="col-xs-12">
                    <div class="alert alert-warning custom-message">Note: add a <a
                                href="http://invninjv1.local/settings/invoice_settings#invoice_fields" target="_blank">Custom
                            Field</a> named "Exchange Rate" to show the totals using a single base currency.
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel panel-default dashboard" style="height:320px">
                        <div class="panel-heading">
                            <h3 class="panel-title in-bold-white">
                                <i class="glyphicon glyphicon-exclamation-sign"></i> Activity
                            </h3>
                        </div>
                    ...
                    <div class="panel panel-default dashboard" style="height:320px;">
                        <div class="panel-heading" style="margin:0; background-color: #f5f5f5 !important;">
                            <h3 class="panel-title" style="color: black !important">
                                <i class="glyphicon glyphicon-ok-sign"></i> Recent Payments
                            </h3>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a href="https://www.invoiceninja.com/?utm_source=powered_by" target="_blank"
                       title="Created by Hillel Coren">Invoice Ninja</a> -
                    <a href="https://github.com/invoiceninja/invoiceninja/releases" target="_blank"
                       title="Trello Roadmap">v4.5.46</a> |

                    White labeled

                    <div class="modal fade" id="whiteLabelModal" tabindex="-1" role="dialog"
                         aria-labelledby="whiteLabelModalLabel"
                         aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <p>Purchase a ONE YEAR white label license for $30 to remove the Invoice
                                                Ninja branding from the invoice and client portal.</p>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h4>Before</h4>
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                         data-src="http://invninjv1.local/images/pro_plan/white_label_before.png"
                                                         width="100%"
                                                         alt="before">
                                                </div>
                                                <div class="col-md-6">
                                                    <h4>After</h4>
                                                    <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs="
                                                         data-src="http://invninjv1.local/images/pro_plan/white_label_after.png"
                                                         width="100%"
                                                         alt="after">
                                                </div>
                                            </div>
                                            <br/>
                                            <p>Note: the white-label license is intended for personal use, please email
                                                us at <a
                                                        href="m&#97;i&#108;&#116;&#111;&#x3a;&#x63;&#111;&#110;t&#97;c&#116;&#64;&#x69;&#110;&#x76;oi&#x63;&#x65;&#x6e;&#x69;n&#106;&#x61;&#46;&#x63;&#x6f;&#x6d;">&#x63;&#111;&#110;t&#97;c&#116;&#64;&#x69;&#110;&#x76;oi&#x63;&#x65;&#x6e;&#x69;n&#106;&#x61;&#46;&#x63;&#x6f;&#x6d;</a>
                                                if you'd like to resell the app.</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-footer" id="signUpFooter" style="margin-top: 0px">
                                    ...
                                    <button type="button" class="btn btn-primary"
                                            onclick="showApplyLicense()">Apply
                                    </button>
                                    <button type="button" class="btn btn-success"
                                            onclick="buyWhiteLabel()">Purchase
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal fade" id="applyWhiteLabelModal" tabindex="-1" role="dialog"
                         aria-labelledby="applyWhiteLabelModal"
                         aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <form accept-charset="utf-8" class="form-horizontal" method="POST">
                                                <div class="form-group required"><label for="white_label_license_key"
                                                                                        class="control-label col-lg-4 col-sm-4">License
                                                        Key</label>
                                                    <div class="col-lg-8 col-sm-8"><input required pattern=".{24,}"
                                                                                          maxlength="24"
                                                                                          class="form-control"
                                                                                          id="white_label_license_key"
                                                                                          type="input"
                                                                                          name="white_label_license_key">
                                                    </div>
                                                </div>
                                                <input type="hidden" name="_token"
                                                       value="T44A86pl7r3nY4v1nUO7grSKH8OzN0IXPzqnQurx"></form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal fade" id="recoverWhiteLabelModal" tabindex="-1" role="dialog"
                         aria-labelledby="recoverWhiteLabelModal"
                         aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <form accept-charset="utf-8" class="form-horizontal" method="POST">
                                                <div class="form-group required"><label for="white_label_license_email"
                                                                                        class="control-label col-lg-4 col-sm-4">Email</label>
                                                    <div class="col-lg-8 col-sm-8"><input required class="form-control"
                                                                                          id="white_label_license_email"
                                                                                          type="email"
                                                                                          name="white_label_license_email">
                                                    </div>
                                                </div>
                                                <input type="hidden" name="_token"
                                                       value="T44A86pl7r3nY4v1nUO7grSKH8OzN0IXPzqnQurx"></form>
                    ...
                    <script type="text/javascript">
                        ...
                        function buyProduct(affiliateKey, productId) {
                            location.href = "http://invninjv1.local/white_label/purchase";
                        }
                        ...
                        function applyLicense() {
                            ...
                            window.location = "http://invninjv1.local/dashboard?license_key=" + license + "&product_id=3";
                        }
    ...
    <form accept-charset="utf-8" class="form-vertical contact-us-form" onsubmit="return onContactUsFormSubmit()"
          method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="container" style="width: 100%; padding-bottom: 0px !important">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="input-div">
                                    <div class="form-group required"><label for="" class="control-label">From</label>
                                        <div required class="form-control-static" id="contact_us_from">John Doe &lt;johndoe@gmail.com&gt;</div>
                                    </div>

                                    <div class="form-group required"><label for="contact_us_message"
                                                                            class="control-label">Message</label><textarea
                                                required class="form-control" rows="10" id="contact_us_message"
                                                name="contact_us_message"></textarea></div>

                                    <div class="form-group">
                                        <div class="checkbox"><label for="include_errors" class=""><input type="hidden"
                                                                                                          name="include_errors"
                                                                                                          value="0"><input
                                                        id="include_errors" type="checkbox" name="include_errors"
                                                        value="1">Include <a href="http://invninjv1.local/errors"
                                                                             target="_blank">recent errors</a> from
                                                storage/logs/laravel-error.log</label></div>
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#contactUsModal').on('shown.bs.modal', function () {
                var message = '';
                message = '\n\n' + "App Version: v4.5.46\nWhite Label: Yes - tgq8xrz4ibnqwhp5g2reufut5vp9snej\nServer OS: Linux 5.10.0-kali3-amd64\nPHP Version: 8.1.22\nMySQL Version: 5.7.42";
        ...
        function onContactUsFormSubmit() {
            ...
            $.post("http://invninjv1.local/contact_us", $('.contact-us-form').serialize(), function (data) {
    ...
    <script type="text/javascript">
        ...
        function showSignUp() {
            if (location.href.indexOf('/dashboard') == -1) {
                location.href = "http://invninjv1.local/dashboard?sign_up=true";
            } else {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result) {
                        hideSignUp();
                        NINJA.formIsChanged = false;
                        location.href = "http://invninjv1.local/dashboard";
                    }
                }
            });
        }
    ...
    <div class="modal fade" id="signUpModal" tabindex="-1" role="dialog" aria-labelledby="signUpModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Add CompanyPlan</h4>
                </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div id="signUpDiv" onkeyup="validateSignUp()" onclick="validateSignUp()"
                                ...
                                <form accept-charset="utf-8" class="form-horizontal signUpForm" autocomplete="off"
                                      method="POST" action="http://invninjv1.local/signup/submit">


                                    <div style="display:none">
                                        <div class="form-group"><label for="path"
                                                                       class="control-label col-lg-4 col-sm-4">path</label>
                                            <div class="col-lg-8 col-sm-8"><input class="form-control" id="path"
                                                                                  type="text" name="path"
                                                                                  value="dashboard"></div>
                                        </div>
                                        <div class="form-group"><label for="go_pro"
                                                                       class="control-label col-lg-4 col-sm-4">Go
                                                Pro</label>
                                            <div class="col-lg-8 col-sm-8"><input class="form-control" id="go_pro"
                                                                                  type="text" name="go_pro"></div>
                                        </div>
                                    </div>

                                    <div class="row signup-form">
                                        <div class="col-md-12">
                                            <div class="checkbox"><label for="terms_checkbox" class=""><input
                                                            type="hidden" name="terms_checkbox" value="0"><input
                                                            id="terms_checkbox" type="checkbox" name="terms_checkbox"
                                                            value="1">I agree to the <a
                                                            href="https://www.invoiceninja.com/self-hosting-terms-service/"
                                                            target="_blank">Terms of Service</a></label></div>
                                            <div class="checkbox"><label for="privacy_checkbox" class=""><input
                                                            type="hidden" name="privacy_checkbox" value="0"><input
                                                            id="privacy_checkbox" type="checkbox"
                                                            name="privacy_checkbox" value="1">I agree to the <a
                                                            href="https://www.invoiceninja.com/self-hosting-privacy-data-control/"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group"><label for="new_first_name"
                                                                           class="control-label col-lg-0 col-sm-0"> </label>
                                                <div class="col-lg-12 col-sm-12"><input class="form-control"
                                                                                        placeholder="First Name"
                                                                                        autocomplete="given-name"
                                                                                        data-lpignore="true"
                                                                                        id="new_first_name" type="text"
                                                                                        name="new_first_name"></div>
                                            </div>
                                            <div class="form-group"><label for="new_last_name"
                                                                           class="control-label col-lg-0 col-sm-0"> </label>
                                                <div class="col-lg-12 col-sm-12"><input class="form-control"
                                                                                        placeholder="Last Name"
                                                                                        autocomplete="family-name"
                                                                                        data-lpignore="true"
                                                                                        id="new_last_name" type="text"
                                                                                        name="new_last_name"></div>
                                            </div>
                                            <div class="form-group"><label for="new_email"
                                                                           class="control-label col-lg-0 col-sm-0"> </label>
                                                <div class="col-lg-12 col-sm-12"><input class="form-control"
                                                                                        placeholder="Email"
                                                                                        autocomplete="email"
                                                                                        data-lpignore="true"
                                                                                        id="new_email" type="text"
                                                                                        name="new_email"></div>
                                            </div>
                                            <div class="form-group"><label for="new_password"
                                                                           class="control-label col-lg-0 col-sm-0"> </label>
                                                <div class="col-lg-12 col-sm-12"><input class="form-control"
                                                                                        placeholder="Password"
                                                                                        autocomplete="new-password"
                                                                                        data-lpignore="true"
                                                                                        id="new_password" type="text"
                                                                                        name="new_password"><span
                                                            class="help-block"><span id="passwordStrength">&nbsp;</span></span>
                                                </div>
                                            </div>
                                        ...
                                        <center>
                                            <div id="errorTaken" style="display:none">&nbsp;<br/><b>The email address is
                                                    already registered</b></div>
                                        </center>

                                        <div class="col-md-12">
                                            <div style="padding-top:20px;padding-bottom:10px;">
                                                We require each companyPlan to have a unique email address.<br/>Consider
                                                using an alias. ie, email+label@example.com
                                            </div>
                                        </div>
                                    </div>

                                    <input type="hidden" name="_token" value="T44A86pl7r3nY4v1nUO7grSKH8OzN0IXPzqnQurx">
                                </form>
                            ...
                            <div style="background-color: #fff; padding-right:20px;padding-left:20px; display:none"
                                ...
                                <h3>Success</h3>
                                <br/>
                                You have successfully registered! Please visit the link in the company confirmation
        ...
        <span id="signUpFooter">
            <button type="button" class="btn btn-default" id="closeSignUpButton" data-dismiss="modal">Close <i
            ...
            <button type="button" class="btn btn-primary" id="saveSignUpButton" onclick="validateServerSignUp()"
                    disabled>Save <i class="glyphicon glyphicon-floppy-disk"></i></button>
        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="helpModal" tabindex="-1" role="dialog" aria-labelledby="helpModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                            ...
                            <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane" id="voice_commands">
                                    <div class="row">
                                        ...
                                        <p>
                                            We're actively working to improve this feature, if there's a command you'd
                                            like us to support please email us at <a
                                                    href="m&#97;&#x69;&#x6c;&#x74;&#111;&#58;&#0;">&#0;</a>.
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <a class="btn btn-primary" href="https://www.invoiceninja.com/knowledge-base/" target="_blank">Knowledge
                        Base</a>
                    <a class="btn btn-primary"
                       href="https://invoice-ninja.readthedocs.io/en/latest/introduction.html#dashboard"
                       target="_blank">User Guide</a>
                    <a class="btn btn-primary" href="https://www.youtube.com/channel/UCXAHcBvhW05PDtWYIq7WDFA/videos"
                       target="_blank">YouTube Videos</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            if ('http://invninjv1.local/dashboard' != settingsURL) {
        ...
        Mousetrap.bind('g r c', function(e) {
            location.href = "http://invninjv1.local/reports/calendar";
        });
        */

            Mousetrap.bind('g r', function (e) {
                location.href = "http://invninjv1.local/reports";
            });
            ...
            Mousetrap.bind('n i', function (e) {
                var link = "http://invninjv1.local/invoices/create";
            ...
            Mousetrap.bind('l i', function (e) {
                location.href = "http://invninjv1.local/invoices";
            });
            Mousetrap.bind('n p', function (e) {
                var link = "http://invninjv1.local/payments/create";
                if (location.pathname.indexOf('/clients/') >= 0) {
                    var matches = location.pathname.match(/\d+/g);
                    if (matches.length) {
                        link += '/' + matches[0];
            ...
            Mousetrap.bind('l p', function (e) {
                location.href = "http://invninjv1.local/payments";
            });
            Mousetrap.bind('n e', function (e) {
                var link = "http://invninjv1.local/expenses/create";
                location.href = link;
            });
            Mousetrap.bind('l e', function (e) {
                location.href = "http://invninjv1.local/expenses";
            });
            Mousetrap.bind('n t', function (e) {
                var link = "http://invninjv1.local/tasks/create";
                if (location.pathname.indexOf('/clients/') >= 0) {
                    var matches = location.pathname.match(/\d+/g);
                    if (matches.length) {
                        link += '/' + matches[0];
            ...
            Mousetrap.bind('l t', function (e) {
                location.href = "http://invninjv1.local/tasks";
            });
            Mousetrap.bind('n c', function (e) {
                var link = "http://invninjv1.local/clients/create";
                location.href = link;
            });
            Mousetrap.bind('l c', function (e) {
                location.href = "http://invninjv1.local/clients";
            });
            Mousetrap.bind('n q', function (e) {
                var link = "http://invninjv1.local/quotes/create";
                location.href = link;
            });
            Mousetrap.bind('l q', function (e) {
                location.href = "http://invninjv1.local/quotes";
            });
            Mousetrap.bind('n v', function (e) {
                var link = "http://invninjv1.local/vendors/create";
                if (location.pathname.indexOf('/clients/') >= 0) {
                    var matches = location.pathname.match(/\d+/g);
                    if (matches.length) {
                        link += '/' + matches[0];
            ...
            Mousetrap.bind('l v', function (e) {
                location.href = "http://invninjv1.local/vendors";
            });
            Mousetrap.bind('n r', function (e) {
                var link = "http://invninjv1.local/recurring_invoices/create";
                if (location.pathname.indexOf('/clients/') >= 0) {
                    var matches = location.pathname.match(/\d+/g);
                    if (matches.length) {
                        link += '/' + matches[0];
            ...
            Mousetrap.bind('l r', function (e) {
                location.href = "http://invninjv1.local/recurring_invoices";
            });

            Mousetrap.bind('g c d', function (e) {
                location.href = "http://invninjv1.local/settings/company_details";
            });
            Mousetrap.bind('g u d', function (e) {
                location.href = "http://invninjv1.local/settings/user_details";
            });
            Mousetrap.bind('g l', function (e) {
                location.href = "http://invninjv1.local/settings/localization";
            });
            Mousetrap.bind('g o p', function (e) {
                location.href = "http://invninjv1.local/settings/online_payments";
            });
            Mousetrap.bind('g t x', function (e) {
                location.href = "http://invninjv1.local/settings/tax_rates";
            });
            Mousetrap.bind('g p', function (e) {
                location.href = "http://invninjv1.local/settings/products";
            });
            Mousetrap.bind('g n', function (e) {
                location.href = "http://invninjv1.local/settings/notifications";
            });
            Mousetrap.bind('g i e', function (e) {
                location.href = "http://invninjv1.local/settings/import_export";
            });
            Mousetrap.bind('g a m', function (e) {
                location.href = "http://invninjv1.local/settings/account_management";
            });
            Mousetrap.bind('g i s', function (e) {
                location.href = "http://invninjv1.local/settings/invoice_settings";
            });
            Mousetrap.bind('g i d', function (e) {
                location.href = "http://invninjv1.local/settings/invoice_design";
            });
            Mousetrap.bind('g c p', function (e) {
                location.href = "http://invninjv1.local/settings/client_portal";
            });
            Mousetrap.bind('g e', function (e) {
                location.href = "http://invninjv1.local/settings/email_settings";
            });
            Mousetrap.bind('g t r', function (e) {
                location.href = "http://invninjv1.local/settings/templates_and_reminders";
            });
            Mousetrap.bind('g c c', function (e) {
                location.href = "http://invninjv1.local/settings/bank_accounts";
            });
            Mousetrap.bind('g v', function (e) {
                location.href = "http://invninjv1.local/settings/data_visualizations";
            });
            Mousetrap.bind('g a t', function (e) {
                location.href = "http://invninjv1.local/settings/api_tokens";
            });
            Mousetrap.bind('g u m', function (e) {
                location.href = "http://invninjv1.local/settings/user_management";
            });
    ...
    <form accept-charset="utf-8" class="form-horizontal" id="acceptTermsForm" method="POST"
          action="http://invninjv1.local/accept_terms">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="container" style="width: 100%; padding-bottom: 0px !important">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="checkbox"><label for="accepted_terms" class=""><input required type="hidden"
                                                                                                  name="accepted_terms"
                                                                                                  value="0"><input
                                                required id="accepted_terms" type="checkbox" name="accepted_terms"
                                                value="1">I agree to the <a
                                                href="https://www.invoiceninja.com/self-hosting-terms-service/"
                                                target="_blank">Terms of Service</a></label></div>
                                <div class="checkbox"><label for="accepted_privacy" class=""><input required
                                                                                                    type="hidden"
                                                                                                    name="accepted_privacy"
                                                                                                    value="0"><input
                                                required id="accepted_privacy" type="checkbox" name="accepted_privacy"
                                                value="1">I agree to the <a
                                                href="https://www.invoiceninja.com/self-hosting-privacy-data-control/"
                                                target="_blank">Privacy Policy</a></label></div>
                            </div>
