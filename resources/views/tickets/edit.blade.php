        ...
        <div id='downhere'>
            ...
            <div role="tabpanel" class="panel-default" style="margin-top:30px;">
                ...
                <ul class="nav nav-tabs" role="tablist" style="border: none">
                    <li role="presentation" class="active"><a href="#private_notes" aria-controls="private_notes"
                                                              role="tab"
                                                              data-toggle="tab">{{ trans("texts.private_notes") }}</a>
                    </li>
                    ...
                    @endif
                    <li role="presentation"><a href="#linked_objects" aria-controls="linked_objects" role="tab"
                                               data-toggle="tab">{{ trans("texts.linked_objects") }}</a></li>
                </ul>
                ...
                <div class="tab-content" style="padding-right:12px;">
                    ...
                    <div row="tabpanel" class="tab-pane" id="linked_objects"
                         style="width:600px;min-height: 300px; height: auto !important;">
                        ...
                        <div style="">
                            ...
                            <div style="float:left;margin:10px;">
                                {!! Former::select('linked_object')
                                    ...
                                    ->addOption('', '')
                                    ->fromQuery(Ticket::relationEntities())
                    ...
                    mentions: {
                        ...
                        source: function (query, process, delimiter) {
                            ...
                            if (delimiter === '#') {
                                ...
                                process({!! Ticket::templateVariables() !!})
                            }
                        }
                    },
