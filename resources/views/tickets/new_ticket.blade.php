...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div id="descriptionEditor" class="form-control" style="min-height:160px; max-height:160px;"
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <input id="due_date" type="text" data-bind="value: due_date.pretty" name="due_date"
                           class="form-control time-input time-input-end" placeholder="{{ trans('texts.due_at') }}"/>
                </div>
    ...
    <div role="tabpanel" class="panel-default" style="margin-top:30px;">
        ...
        <ul class="nav nav-tabs" role="tablist" style="border: none">
            <li role="presentation" class="active"><a href="#private_notes" aria-controls="private_notes" role="tab"
