...
@section('content')
    ...
    <div style="display:none">
        ...
        {!! Former::hidden('company_id')->value($company->id) !!}
                    ...
                    <td width="50%">
                        <table class="table table-striped dataTable">
                            ...
                            <tr>
                                ...
                                <td>{!! Utils::fromSqlDateTime($ticket->created_at) !!}</td>
                            </tr>
                            <tr>
                                <td class="td-left">{!! trans('texts.last_updated') !!}:</td>
                                <td>{!! Utils::fromSqlDateTime($ticket->updated_at) !!}</td>
                            </tr>
                            <tr>
        ...
        <div class="panel-default ui-accordion ui-widget ui-helper-reset" id="accordion" role="tablist">
            @foreach($ticket->comments as $comment)
                <h3 class="ui-accordion-header ui-corner-top ui-state-default ui-accordion-header-active ui-state-active ui-accordion-icons"
                    role="tab" id="accordion">{!! $comment->getCommentHeader() !!}</h3>
                <div>
                    <p>
                        {!! $comment->description !!}
                    </p>
    ...
    <div role="tabpanel" class="panel panel-default" style="margin-top:30px;">
        ...
        <ul class="nav nav-tabs" role="tablist" style="border: none">
            @if ($company->hasFeature(FEATURE_DOCUMENTS))
                <li role="presentation" class="active"><a href="#attached-documents" aria-controls="attached-documents"
   ...
   Modals
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            @include('partials.client_dropzone', ['documentSource' => 'model.documents()', 'company_ticket_settings' => $company_ticket_settings])
