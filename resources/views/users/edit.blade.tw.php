    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            @if ( ! Utils::hasFeature(FEATURE_USER_PERMISSIONS))
                <div class="relative px-3 py-3 mb-4 border rounded text-yellow-darker border-yellow-dark bg-yellow-lighter">{{ trans('texts.upgrade_for_permissions') }}</div>
            ...
            <div class="panel-body">
                <table class="w-full max-w-full mb-4 bg-transparent table-striped dataTable" >
                    <thead>
                    <th></th>
