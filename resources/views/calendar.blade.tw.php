...
@section('top-right')
	<div id="entityTypeFilterWrapper" style="display:none">
	    <select class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" style="width: 220px;" id="entityTypeFilter" multiple="true">
