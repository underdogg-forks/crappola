<tr>
    ...
    @if ($company->customLabel('client1'))
        <td>{{ $company->present()->customLabel('client1') }}</td>
    @endif
    @if ($company->customLabel('client2'))
        <td>{{ $company->present()->customLabel('client2') }}</td>
    @endif
    ...
    @if ($company->customLabel('contact1'))
        <td>{{ $company->present()->customLabel('contact1') }}</td>
    @endif
    @if ($company->customLabel('contact2'))
        <td>{{ $company->present()->customLabel('contact2') }}</td>
    @endif
</tr>
