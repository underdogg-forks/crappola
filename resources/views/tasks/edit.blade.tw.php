...
@section('content')
    ...
    @if ($errors->first('time_log'))
        <div class="relative px-3 py-3 mb-4 border rounded text-red-darker border-red-dark bg-red-lighter"><li>{{ trans('texts.task_errors') }}  </li></div>
    @endif
    ...
    <div class="flex flex-wrap" onkeypress="formEnterClick(event)">
        <div class="md:w-full pr-4 pl-4">
            ...
            @if ($task)
                ...
                <div class="mb-4 simple-time" id="editDetailsLink">
                    <label for="simple-time" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4">
                    </label>
                    <div class="lg:w-2/3 pr-4 pl-4 sm:w-2/3 pr-4 pl-4" style="padding-top: 10px">
            ...
            <div class="mb-4 simple-time" id="datetime-details" style="display: none">
                <label for="simple-time" class="control-label lg:w-1/3 pr-4 pl-4 sm:w-1/3 pr-4 pl-4">
                    {{ trans('texts.times') }}
                </label>
                <div class="lg:w-2/3 pr-4 pl-4 sm:w-2/3 pr-4 pl-4">

                <table class="w-full max-w-full mb-4 bg-transparent" style="margin-bottom: 0px !important;">
                            ...
                            <td style="padding: 0px 12px 12px 0 !important">
                                <div data-bind="css: { 'has-error': !isStartValid() }">
                                    <input type="text" data-bind="dateTimePicker: startTime.pretty, event:{ change: $root.refresh }"
                                        class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded time-input time-input-start" placeholder="{{ trans('texts.start_time') }}"/>
                                </div>
                            </td>
                            <td style="padding: 0px 12px 12px 0 !important">
                                <div data-bind="css: { 'has-error': !isEndValid() }">
                                    <input type="text" data-bind="dateTimePicker: endTime.pretty, event:{ change: $root.refresh }"
                                        class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded time-input time-input-end" placeholder="{{ trans('texts.end_time') }}"/>
                                </div>
                            </td>
                            <td style="padding: 0px 12px 12px 0 !important; width:100px">
                                <input type="text" data-bind="value: duration.pretty, visible: !isEmpty()" class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded duration"></div>
