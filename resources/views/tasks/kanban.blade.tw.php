...
@section('top-right')
    <div class="mb-4">
        <input type="text" data-bind="value: filter" placeholder="{{ trans('texts.filter') }}" id="filter"
            class="block appearance-none w-full py-1 px-2 mb-1 text-base leading-normal bg-white text-grey-darker border border-grey rounded" style="background-color: #FFFFFF !important"/>
    </div>
@stop
        ...
        <div data-bind="sortable: { data: statuses, as: 'status', afterMove: onStatusDragged, allowDrop: true, connectClass: 'connect-column' }" style="float:left">
            <div class="well kanban-column">
                    ...
                    <div class="kanban-column-row" data-bind="css: { editing: is_editing_task }, visible: task.matchesFilter($root.filter(), $root.filter_client_id(), $root.filter_project_id())">
                        ...
                        <div class="edit">
                            ...
                            <div class="pull-right">
                                <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default py-1 px-2 text-sm leading-tight' data-bind="click: cancelEditTask">
                                    {{ trans('texts.cancel') }}
                                </button>
                                <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-blue-lightest bg-blue hover:bg-blue-light py-1 px-2 text-sm leading-tight' data-bind="click: viewTask">
                                    {{ trans('texts.view') }}
                                </button>
                                <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-green-lightest bg-green hover:bg-green-light py-1 px-2 text-sm leading-tight' data-bind="click: saveEditTask">
                                    {{ trans('texts.save') }}
                                </button>
                            </div>
                ...
                <div class="kanban-column-row" data-bind="css: { editing: new_task.is_editing_task }, with: new_task" style="padding-bottom:6px">
                    <div class="view" data-bind="event: { click: startEditTask }">
                        <a href="#" class="text-grey" style="font-size:13px" data-bind="visible: is_blank">
                    ...
                    <div class="edit">
                        ...
                        <div class="pull-right">
                            <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default py-1 px-2 text-sm leading-tight' data-bind="click: $parent.cancelNewTask">
                                {{ trans('texts.cancel') }}
                            </button>
                            <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-green-lightest bg-green hover:bg-green-light py-1 px-2 text-sm leading-tight' data-bind="click: $parent.saveNewTask">
                                {{ trans('texts.save') }}
                            </button>
                        </div>
                    </div>
        ...
        <div class="kanban-column kanban-column-last well">
            <div class="kanban-column-row" data-bind="css: { editing: is_adding_status }">
                <div class="view" data-bind="event: { click: startNewStatus }" style="padding-bottom: 8px;">
                    <a href="#" class="text-grey" style="font-size:13px">
                ...
                <div class="edit">
                    ...
                    <div class="pull-right" style="padding-top:6px">
                        <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline btn-default py-1 px-2 text-sm leading-tight' data-bind="click: cancelNewStatus">
                            {{ trans('texts.cancel') }}
                        </button>
                        <!--
                        <button type='button' class='inline-block align-middle text-center select-none border font-normal whitespace-no-wrap py-2 px-4 rounded text-base leading-normal no-underline text-green-lightest bg-green hover:bg-green-light py-1 px-2 text-sm leading-tight' data-bind="click: saveNewStatus">
                            {{ trans('texts.save') }}
                        </button>
                        -->
                    </div>
