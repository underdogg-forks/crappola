...
@section('content')
    ...
    @include('companies.nav', ['selected' => ACCOUNT_TAX_RATES])
    ...
    {{ Former::populateField('inclusive_taxes', intval($company->inclusive_taxes)) }}
        ...
        <div class="panel-body">
            ...
            @elseif ($countInvoices <= 25)
                {!! Former::plaintext(' ')->help(
                        trans($company->inclusive_taxes ? 'texts.taxes_are_included_help' : 'texts.taxes_are_not_included_help') . '<br/>' .
                        trans('texts.change_requires_purge', ['link' => link_to(url('/settings/account_management'), trans('texts.purging'))])) !!}
            @else
                {!! Former::plaintext(' ')->help(
                        trans($company->inclusive_taxes ? 'texts.taxes_are_included_help' : 'texts.taxes_are_not_included_help'))  !!}
            @endif&nbsp;
