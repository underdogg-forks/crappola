...
@section('content')
    @parent
    @include('companies.nav', ['selected' => ACCOUNT_EMAIL_SETTINGS, 'advanced' => true])
    ...
    {{ Former::populateField('ubl_email_attachment', intval($company->ubl_email_attachment)) }}
    {{ Former::populateField('document_email_attachment', intval($company->document_email_attachment)) }}
    {{ Former::populateField('email_design_id', intval($company->account_email_settings->email_design_id)) }}
    {{ Former::populateField('enable_email_markup', intval($company->account_email_settings->enable_email_markup)) }}
    {{ Former::populateField('email_footer', $company->account_email_settings->email_footer) }}
    {{ Former::populateField('bcc_email', $company->account_email_settings->bcc_email) }}
    {{ Former::populateField('reply_to_email', $company->account_email_settings->reply_to_email) }}
