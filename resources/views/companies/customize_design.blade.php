...
@section('content')
    ...
    <script>
        ...
        function getPDFString(cb, force) {
            ...
            NINJA.primaryColor = {!! json_encode(Auth::user()->company->primary_color) !!};
            NINJA.secondaryColor = {!! json_encode(Auth::user()->company->secondary_color) !!};
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div role="tabpanel">
                <ul class="nav nav-tabs" role="tablist" style="border: none">
                    ...
                    @if ($company->isEnterprise() && $company->background_image_id)
                        ...
                        <div class="container" style="width: 100%; padding-bottom: 0px !important">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    ...
                                    @include('partials/variables_help', ['entityType' => ENTITY_INVOICE, 'company' => $company])
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            ...
            @include('invoices.pdf', ['company' => Auth::user()->company, 'pdfHeight' => 930])
