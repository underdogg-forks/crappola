...
@section('content')
    ...
    {{ Former::populateField('task_rate', floatval($company->task_rate) ? Utils::roundSignificant($company->task_rate) : '') }}
    {{ Former::populateField('valid_until_days', intval($company->valid_until_days) ? $company->valid_until_days : '') }}

    @include('companies.nav', ['selected' => ACCOUNT_COMPANY_DETAILS])
