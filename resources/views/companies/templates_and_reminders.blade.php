...
@section('content')
    @parent
    @include('companies.nav', ['selected' => ACCOUNT_TEMPLATES_AND_REMINDERS, 'advanced' => true])
            ...
            <div class="row">
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        ...
                        @include('companies.template', ['field' => 'proposal'])
        ...
        <div class="panel-body">
            <div class="row">
                <div role="tabpanel">
                    ...
                    <div class="tab-content">
                        @include('companies.template', ['field' => 'reminder1', 'number' => 1, 'isReminder' => true, 'active' => true])
                        @include('companies.template', ['field' => 'reminder2', 'number' => 2, 'isReminder' => true])
                        @include('companies.template', ['field' => 'reminder3', 'number' => 3, 'isReminder' => true])
                        @include('companies.template', ['field' => 'reminder4', 'number' => 4, 'isReminder' => true])
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="row">
                <div role="tabpanel">
                    <ul class="nav nav-tabs" role="tablist" style="border: none">
                        <li role="presentation" class="active"><a href="#quote_reminder1" aria-controls="notes"
                                                                  role="tab"
                                                                  data-toggle="tab">{{ trans('texts.first_reminder') }}</a>
                        </li>
                        <li role="presentation"><a href="#quote_reminder2" aria-controls="terms" role="tab"
                                                   data-toggle="tab">{{ trans('texts.second_reminder') }}</a></li>
                        <li role="presentation"><a href="#quote_reminder3" aria-controls="footer" role="tab"
                                                   data-toggle="tab">{{ trans('texts.third_reminder') }}</a></li>
                        <li role="presentation"><a href="#quote_reminder4" aria-controls="footer" role="tab"
                                                   data-toggle="tab">{{ trans('texts.endless_reminder') }}</a></li>
                    </ul>
                    <div class="tab-content">
                        @include('companies.quote_template', ['field' => 'quote_reminder1', 'number' => 1, 'isReminder' => true, 'active' => true])
                        @include('companies.quote_template', ['field' => 'quote_reminder2', 'number' => 2, 'isReminder' => true])
                        @include('companies.quote_template', ['field' => 'quote_reminder3', 'number' => 3, 'isReminder' => true])
                        @include('companies.quote_template', ['field' => 'quote_reminder4', 'number' => 4, 'isReminder' => true])
                    </div>
                </div>
            </div>
        </div>
