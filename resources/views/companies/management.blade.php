...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="panel-body">
                    ...
                    @else
                        ...
                        @if ($planDetails && $planDetails['active'])
                            ...
                            @if ($company->companyPlan->hasActiveDiscount())
                                {!! Former::plaintext('discount')
                                        ->value($company->companyPlan->present()->discountMessage) !!}
                            @endif
                            ...
                            <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        {!! Former::plaintext(' ')
                                            ->inlineHelp($company->companyPlan->present()->promoMessage) !!}
            ...
            {!! Former::populateField('realtime_preview', intval($company->realtime_preview)) !!}
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-lg-8 col-sm-8">
                            @foreach (Company::$modules as $entityType => $value)
                                <div class="checkbox">
                                    <label for="modules_{{ $value}}">
                                        <input name="modules[]" id="modules_{{ $value}}" type="checkbox"
                                               {{ Auth::user()->company->isModuleEnabled($entityType) ? 'checked="checked"' : '' }} value="{{ $value }}">{{ trans("texts.module_{$entityType}") }}
                                    </label>
                                </div>
                            @endforeach
                            @if (Utils::isSelfHost())
            ...
            @if (! Auth::user()->company->isNinjaOrLicenseAccount())
                <div class="panel panel-default">
                    <div class="panel-heading">
                    ...
                    <div class="panel-body">
                        ...
                        @if (! $company->hasMultipleAccounts() || $company->getPrimaryAccount()->id != $company->id)
                            {!! Former::open('settings/cancel_account')->addClass('cancel-company') !!}
                            {!! Former::actions( Button::danger($company->hasMultipleAccounts() ? trans('texts.delete_company') : trans('texts.cancel_account'))->large()->withAttributes(['onclick' => 'showCancelConfirm()'])->appendIcon(Icon::create('trash'))) !!}
                            <div class="form-group">
                                <div class="col-lg-8 col-sm-8 col-lg-offset-4 col-sm-offset-4">
                                    <span class="help-block">{{ $company->hasMultipleAccounts() ? trans('texts.delete_company_help') : trans('texts.cancel_account_help') }}</span>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog" style="min-width:150px">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title"
                                                id="confirmCancelModalLabel">{{ $company->hasMultipleAccounts() ? trans('texts.delete_company') : trans('texts.cancel_account') }}</h4>
                                        </div>
                                        <div class="container" style="width: 100%; padding-bottom: 0px !important">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <p>
                                                        <b>{{ $company->hasMultipleAccounts() ? trans('texts.delete_company_message') : trans('texts.cancel_account_message') }}</b>
                                                    </p><br/>
                                                    @if ($company->getPrimaryAccount()->id == $company->id)
                                        ...
                                        <div class="modal-footer" style="margin-top: 2px">
                                            ...
                                            <button type="button" class="btn btn-danger" id="deleteButton"
                                                    onclick="confirmCancel()">{{ $company->hasMultipleAccounts() ? trans('texts.delete_company') : trans('texts.cancel_account') }}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        @elseif ($company->hasMultipleAccounts())
                            <div class="form-group">
                                <div class="col-lg-8 col-sm-8 col-lg-offset-4 col-sm-offset-4">
