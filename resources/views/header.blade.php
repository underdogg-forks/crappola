                    ...
                    <div class="navbar-form navbar-right">
                        ...
                        <div class="btn-group user-dropdown">
                            <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown">
                                <div id="myAccountButton" class="ellipsis nav-account-name"
                        ...
                        <li class="dropdown">
                            @if (Utils::isAdmin())
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    @endforeach
                                    <li>
                                        <a href="{{ url('settings/' . ACCOUNT_INVOICE_SETTINGS) }}">{!! uctrans('texts.advanced_settings') . Utils::getProLabel(ACCOUNT_ADVANCED_SETTINGS) !!}</a>
                                    </li>
                                </ul>
                            @else
