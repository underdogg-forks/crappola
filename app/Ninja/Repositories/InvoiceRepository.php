    ...
    public function save(array $data, Invoice $invoice = null)
    {
        ...
        if ($invoice) {
            ...
            if ($entityType == ENTITY_INVOICE && empty($data['partial_due_date'])) {
                ...
                $invoice->due_date = Carbon::parse($data['invoice_date'])->addDays($company->valid_until_days);
            }
        } else {
        ...
        */
        ...
        if ($invoice->is_recurring) {
            ...
            if (isset($data['recurring_due_date'])) {
                ...
                $invoice->due_date = $data['due_at'];
            }
        } else {
            if ($isNew && empty($data['due_at']) && empty($data['due_date_sql'])) {
                // do nothing
            } elseif (isset($data['due_at']) || isset($data['due_date_sql'])) {
                $invoice->due_date = isset($data['due_date_sql']) ? $data['due_date_sql'] : Utils::toSqlDate($data['due_at']);
            }
