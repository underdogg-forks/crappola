...
class TicketAgentClosed extends BaseTicketAction
{
    ...
    public function fire(Ticket $ticket): void
    {
        ...
        if ($companyTicketSettings->close_ticket_template_id > 0) {
            ...
            $data = [
                ...
                'body' => parent::buildTicketBodyResponse($ticket, $companyTicketSettings, $companyTicketSettings->close_ticket_template_id),
                'company' => $company,
