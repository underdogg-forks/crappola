...
class Company extends Model
{
    ...
    {
        return $this->hasOne('App\Models\AccountTicketSettings', 'company_id');
    }
    ...
    {
        return $this->hasMany('App\Models\AccountToken', 'company_id');
    }
    ...
    {
        return $this->hasMany('App\Models\AccountGatewaySettings','company_id');
    }

    public function account_email_settings(): HasOne
    {
        return $this->hasOne('App\Models\AccountEmailSettings', 'company_id');
    }
    ...
    {
        return $this->hasMany('App\Models\TaxRate', 'company_id');
    }
    ...
    {
        return $this->hasMany('App\Models\TaskStatus', 'company_id')->orderBy('sort_order');
    }
    ...
    {
        return $this->hasMany('App\Models\Document','company_id')->whereIsDefault(true);
    }
    ...
    {
        return $this->belongsTo('App\Models\CompanyPlan');
    }
    ...
    {
        return $this->hasMany('App\Models\PaymentTerm', 'company_id', 'id')->withTrashed();
    }
    ...
    */
    ...
    {
        return $this->hasMany('App\Models\AccountGateway', 'company_id');
    }
