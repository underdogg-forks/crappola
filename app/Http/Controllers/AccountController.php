...
class AccountController extends BaseController
{
    ...
    private function showInvoiceDesign($section)
    {
        ...
        if ($section == ACCOUNT_CUSTOMIZE_DESIGN) {
            if ($custom = $company->getCustomDesign(request()->design_id)) {
    ...
    private function showTickets()
    {
        $data = [
            'company' => Auth::user()->company,
            'account_ticket_settings' => Auth::user()->company->account_ticket_settings,
    ...
    {
        $company_ticket_settings = Auth::user()->company->account_ticket_settings;
