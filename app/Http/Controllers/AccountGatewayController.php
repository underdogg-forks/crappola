...
class AccountGatewayController extends BaseController
{
    ...
    /**
     * @return array{company: mixed, user: mixed, accountGateway: mixed, config: false, gateways: mixed, creditCardTypes: array<string, array{value: mixed, data-imageUrl: string, checked?: string}>, countGateways: mixed}
     */
    private function getViewModel($companyGateway = false): array
    {
