...
class TaskController extends BaseController
{
    ...
    public function bulk()
    {
        ...
        if (strpos($action, 'update_status') === 0) {
            ...
            $tasks = Task::scope($ids)->with('company', 'client', 'project')->orderBy('project_id', 'id')->get();
    ...
    public function create(TaskRequest $request)
    {
        ...
        $data = [
            ...
            'productPublicId' => \Request::old('product_id') ? \Request::old('product_id') : ($request->product_id ?: 0),
            'method'          => 'POST',
            'url'             => 'tasks',
    ...
    /**
     * @return array{clients: mixed, company: mixed, projects: mixed, products: mixed}
     */
