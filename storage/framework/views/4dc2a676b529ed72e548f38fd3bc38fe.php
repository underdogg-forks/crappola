...
<?php if($account->company->hasEarnedPromo()): ?>
	<?php echo $__env->make('partials/discount_promo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php elseif($showBlueVinePromo): ?>
    <?php echo $__env->make('partials/bluevine_promo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<?php if($showWhiteLabelExpired): ?>
	<?php echo $__env->make('partials/white_label_expired', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<?php if($account->account_email_settings->forward_url_for_v5): ?>
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/invninjl10/resources/views/dashboard.blade.php ENDPATH**/ ?>