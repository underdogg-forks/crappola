...
$(function() {
    ...
    showSignUp();
    <?php elseif(Session::get('sign_up') || \Request::input('sign_up')): ?>
    showSignUp();
    <?php endif; ?>
        ...
        <div class="row signup-form">
            ...
            <?php if(Utils::isOAuthEnabled() && ! Auth::user()->registered): ?>
                <div class="col-md-6">
                    ...
                    <a href="<?php echo e(URL::to('auth/' . $provider)); ?>" class=""
                        ...
                        id="<?php echo e(strtolower($provider)); ?>LoginButton">
                            <?php if($provider == SOCIAL_GITHUB): ?>
                                <img style="height: 6rem;" src="<?php echo e(asset('images/btn_github_signin.png')); ?>">
                            <?php elseif($provider == SOCIAL_GOOGLE): ?>
                                <img style="height: 6rem;" src="<?php echo e(asset('images/btn_google_signin_dark_normal_web@2x.png')); ?>">
                            <?php elseif($provider == SOCIAL_LINKEDIN): ?>
                                <img style="height: 6rem;" src="<?php echo e(asset('images/btn_linkedin_signin.png')); ?>">
                            <?php elseif($provider === SOCIAL_FACEBOOK): ?>
                                <img style="height: 6rem;" src="<?php echo e(asset('images/btn_facebook_signin.png')); ?>">
                            <?php endif; ?>
                    </a>
...
<?php /**PATH /var/www/projects/invninjl10/resources/views/partials/sign_up.blade.php ENDPATH**/ ?>