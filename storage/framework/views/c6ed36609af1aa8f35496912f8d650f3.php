...
<script type="text/javascript">
  ...
  $(function() {
    ...
    <?php if(\Request::has('focus')): ?>
        $('#<?php echo e(\Request::input('focus')); ?>').focus();
    <?php endif; ?>
...
<?php if(Utils::isNinjaProd() && ! Request::is('settings/account_management')): ?>
  <?php echo $__env->make('partials.upgrade_modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="height:60px;">
    ...
    <div class="collapse navbar-collapse" id="navbar-collapse-1">
      ...
      <?php echo Former::open(env('SPEECH_ENABLED') ? '/handle_command' : '/#')->id('search-form')->addClass('navbar-form navbar-right')->role('search'); ?>
        ...
        <div class="form-group has-feedback">
          <input type="text" name="command" id="search" style="width: 280px;padding-top:0px;padding-bottom:0px;margin-right:12px;"
            ...
            <?php if(env('SPEECH_ENABLED')): ?>
                <?php echo $__env->make('partials/speech_recognition', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
...
<div id="wrapper" class='<?php echo e(session(SESSION_LEFT_SIDEBAR) ? 'toggled-left' : ''); ?> <?php echo e(session(SESSION_RIGHT_SIDEBAR, true) ? 'toggled-right' : ''); ?>'>
    ...
    <div id="left-sidebar-wrapper" class="hide-phone">
        <ul class="sidebar-nav <?php echo e(Auth::user()->dark_mode ? 'sidebar-nav-dark' : 'sidebar-nav-light'); ?>">
            <?php $__currentLoopData = [
                ...
                <?php else: ?>
                    <?php echo $__env->make('partials.navigation_option', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(Auth::user()->hasPermission('view_reports')): ?>
                <?php echo $__env->make('partials.navigation_option', ['option' => 'reports'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
            <?php echo $__env->make('partials.navigation_option', ['option' => 'settings'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <li style="width:100%;">
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
          ...
          <?php echo $__env->make('partials.warn_session', ['redirectTo' => '/dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <?php if(Utils::isNinjaProd()): ?>
                ...
                <?php endif; ?>
              <?php else: ?>
                <?php echo $__env->make('partials.white_label', ['company' => Auth::user()->account->company], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
              <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('partials.contact_us', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('partials.sign_up', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if(!request()->is('*proposals*')): ?>
    <?php echo $__env->make('partials.keyboard_shortcuts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>

<?php if(auth()->check() && auth()->user()->registered && ! auth()->user()->hasAcceptedLatestTerms()): ?>
    <?php echo $__env->make('partials.accept_terms', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endif; ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/projects/invninjl10/resources/views/header.blade.php ENDPATH**/ ?>