...
class AddRemember2faToken extends Migration
{
    ...
    public function up(): void
    {
        /*Schema::table('users', function ($table): void {
            $table->string('remember_2fa_token', 100)->after('google_2fa_secret')->nullable();
        });
        ...
        Schema::table('tasks', function ($table): void {
            $table->unsignedInteger('task_status_id')->after('product_id')->index()->nullable();
            $table->smallInteger('task_status_sort_order')->after('description')->default(0);
        });*/
