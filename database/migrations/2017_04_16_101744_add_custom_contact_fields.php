...
class AddCustomContactFields extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::table('relations__contacts', function ($table) {
        ...
        /*Schema::table('expenses', function ($table) {
            ...
            //$table->foreign('payment_type_id')->references('id')->on('lookup__payment_types');
            $table->boolean('invoice_documents')->default(true);
        });*/
        // remove duplicate annual frequency
        /*if (DB::table('lookup__frequencies')->count() == 9) {
