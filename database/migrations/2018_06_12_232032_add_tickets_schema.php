...
class AddTicketsSchema extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('company_ticket_settings', function ($table): void {
            $table->increments('id');
        ...
        foreach ($companys as $company) {
            if (! $company->company_ticket_settings) {
                // Create company_ticket_settings record for company
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('company_ticket_settings');
