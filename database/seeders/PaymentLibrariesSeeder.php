...
class PaymentLibrariesSeeder extends Seeder
{
    public function run(): void
    {
        $gateways = [
            ...
            ['name' => 'GoCardless', 'provider' => 'GoCardless', 'payment_library_id' => 2],
            ['name' => 'Migs ThreeParty', 'provider' => 'Migs_ThreeParty'],
            ['name' => 'Migs TwoParty', 'provider' => 'Migs_TwoParty'],
            ['name' => 'Mollie', 'provider' => 'Mollie', 'sort_order' => 8],
            ...
            ['name' => 'PayPal Express', 'provider' => 'PayPal_Express', 'sort_order' => 4],
            ['name' => 'PayPal Pro', 'provider' => 'PayPal_Pro'],
            ['name' => 'Pin', 'provider' => 'Pin'],
            ['name' => 'SagePay Direct', 'provider' => 'SagePay_Direct'],
            ['name' => 'SagePay Server', 'provider' => 'SagePay_Server', 'payment_library_id' => 2],
            ...
            ['name' => 'Skrill', 'provider' => 'Skrill', 'payment_library_id' => 2],
            ['name' => 'BitPay', 'provider' => 'BitPay', 'sort_order' => 7],
            ['name' => 'Dwolla', 'provider' => 'Dwolla', 'sort_order' => 6, 'payment_library_id' => 2],
            ...
            ['name' => 'WePay', 'provider' => 'WePay', 'sort_order' => 3],
            ['name' => 'Braintree', 'provider' => 'Braintree', 'sort_order' => 3],
            ['name' => 'Custom', 'provider' => 'Custom1', 'sort_order' => 20],
            ['name' => 'FirstData Payeezy', 'provider' => 'FirstData_Payeezy'],
            ['name' => 'GoCardless', 'provider' => 'GoCardlessV2\Redirect', 'sort_order' => 9],
            ['name' => 'PagSeguro', 'provider' => 'PagSeguro'],
            ['name' => 'PAYMILL', 'provider' => 'Paymill'],
            ['name' => 'Custom', 'provider' => 'Custom2', 'sort_order' => 21],
            ['name' => 'Custom', 'provider' => 'Custom3', 'sort_order' => 22],
        ];
